...
begin
  ...
  DataSet.FindField('TPDCICOD').Value           := DM.SQLConfigCompraTPDCICOD.AsVariant;
  DataSet.FindField('PORTICOD').Value           := DM.SQLConfigCompraPORTICOD.AsVariant;
  if DataSet.FindField('CTPGCPREVREAL').Value <> '' then
    DataSet.FindField('CTPGCPREVREAL').Value  := DM.SQLConfigCompraCFCOCPREVREALNFCOMPRAFIN.AsString;
