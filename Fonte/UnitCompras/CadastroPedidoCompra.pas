...
type
  TFormCadastroPedidoCompra = class(TFormCadastroTEMPLATE)
    ...
    SQLTemplatePDCPN2TOTITENS: TBCDField;
    SQLTemplatePDCPDPREVENTREGA: TDateTimeField;
    SQLTemplatePDCPDBASEFAT: TDateTimeField;
    SQLTemplatePDCPN2VLRENCARGO: TBCDField;
    SQLTemplatePDCPN2VLRIPI: TBCDField;
    SQLTemplatePDCPN2DESCPROM: TBCDField;
    SQLTemplatePDCPN2VLRFRETE: TBCDField;
    ...
    SQLTemplateTotalCalc: TBCDField;
    Label17: TLabel;
    EvDBNumEdit6: TEvDBNumEdit;
    SQLTemplatePDCPN3TOTDESC: TBCDField;
    Label19: TLabel;
    ...
    SQLPedidoCompraItemPCITN3CAPEMBAL: TBCDField;
    SQLPedidoCompraItemPCITN3PERCDESC: TBCDField;
    SQLPedidoCompraItemPCITN3PERICM: TBCDField;
    SQLPedidoCompraItemPCITN3PERVIPI: TBCDField;
    SQLPedidoCompraItemPCITN3QTDBONIF: TBCDField;
    SQLPedidoCompraItemPCITN3QTDEMBAL: TBCDField;
    SQLPedidoCompraItemPCITN3QTDENTR: TBCDField;
    SQLPedidoCompraItemPCITN3VLRDESC: TBCDField;
    SQLPedidoCompraItemPCITN3VLREMBAL: TBCDField;
    SQLPedidoCompraItemPCITN3VLRICM: TBCDField;
    SQLPedidoCompraItemPCITN3VLRIPI: TBCDField;
    SQLPedidoCompraItemPCITN3VLRUNIT: TBCDField;
    ...
    SQLPedidoCompraItemPDCPN2VLRFRETE: TBCDField;
    SQLPedidoCompraItemPDCPN2VLRENCARGO: TBCDField;
    SQLPedidoCompraItemPDCPN2DESCPROM: TBCDField;
    ...
    SQLFinanceiroCTPGN3VLR: TBCDField;
    ...
    SQLTrocasMVDIN3QTD: TBCDField;
    SQLTrocasLOTEA30NRO: TStringField;
    SQLTrocasMVDIN3VLRCUSTO: TBCDField;
    SQLTrocasPRODN3VLRCOMPRA: TBCDField;
    ...
    SQLTrocasPRODN3VLRCOMPRAMED: TBCDField;
    SQLTrocasPRODN3DOLARCUSTO: TBCDField;
    SQLTrocasPRODN3DOLARCOMPRA: TBCDField;
    SQLTrocasPRODN3DOLARVENDA: TBCDField;
    ...
    SQLTrocasPRODN2PERCFRETE: TBCDField;
    SQLTrocasPRODN2PERDA: TBCDField;
    SQLTrocasPRODN2PIS: TBCDField;
    SQLTrocasPRODN3ALTURA: TBCDField;
    SQLTrocasPRODN3COMPRIMENTO: TBCDField;
    SQLTrocasPRODN3DIMENTOTAL: TBCDField;
    SQLTrocasPRODN3LARGURA: TBCDField;
    SQLTrocasPRODA30INF01ETQBARRAS: TStringField;
    SQLTrocasPRODA30INF02ETQBARRAS: TStringField;
    SQLTrocasCOLEICOD: TIntegerField;
    SQLTrocasPRODN2PERCDESP: TBCDField;
    SQLTrocasPRODN2PERCSUBST: TBCDField;
    SQLTrocasPRODN3VLRTABFOR: TBCDField;
    SQLTrocasDECRICOD: TIntegerField;
    SQLTrocasPRODN3PERCMARGLUC2: TBCDField;
    SQLTrocasPRODN3PERCMGLVFIXA: TBCDField;
    SQLTrocasPRODN3PERCMGLAFIXA: TBCDField;
    SQLTrocasPRODDULTCOMPRA: TDateTimeField;
    SQLTrocasPRODDULTVENDA: TDateTimeField;
    SQLTrocasPRODN2PERCDIFICM: TBCDField;
    SQLTrocasPRODN3QTDULTCOMPRA: TBCDField;
    ...
    SQLTrocasPRODN3MULTIPLIC: TBCDField;
    SQLTrocasPRODN2DOSAGEM: TBCDField;
    SQLTrocasPRODTEXTENDIDO: TStringField;
    SQLTrocasPRODTOBSCOMPLEM: TStringField;
    SQLTrocasPRODN3VLRVENDA2: TBCDField;
    ...
    SQLPedidoCompraItemPCITN3VLRST: TBCDField;
    SQLPedidoCompraItemPCITN3PERCST: TBCDField;
...
uses DataModulo, CadastroPedidoCompraItem, CadastroFornecedor, CadastroTransportadora, CadastroPlanoPagamento,
  TelaEmissaoEtiquetasCodigoBarras, UnitLibrary, CadastroPedidoCompraFinanceiro, DataModuloTemplate, WaitWindow;
...
begin
  inherited;
  EtiquetaPedidoCompra := SQLTemplate.FindField('PDCPA13ID').asString;
