...
type
  TFormTelaReajustePreco = class(TFormTelaGeralTEMPLATE)
    ...
    QueryReajustePRODN3PERCMARGLUCR: TBCDField;
    SQLProdutoPRODN3PERCMGLVFIXA: TBCDField;
    SQLProdutoPRODN3PERCMGLAFIXA: TBCDField;
    SQLProdutoGradePRODN3PERCMARGLUC2: TBCDField;
    SQLProdutoGradePRODN3PERCMGLVFIXA: TBCDField;
    SQLProdutoGradePRODN3PERCMGLAFIXA: TBCDField;
