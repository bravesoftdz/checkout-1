...
type
  TFormCadastroNotaCompra = class(TFormCadastroTEMPLATE)
    ...
    SQLTemplateNOCPN3TOTITENS: TBCDField;
    SQLTemplateNOCPN3VLRTOTNOTA: TBCDField;
    SQLTemplateNOCPN3VLRBASCALICM: TBCDField;
    SQLTemplateNOCPN3VLRICMS: TBCDField;
    SQLTemplateNOCPN3VLRBCICMSSUB: TBCDField;
    SQLTemplateNOCPN3VLRICMSSUB: TBCDField;
    SQLTemplateNOCPN3VLRFRETE: TBCDField;
    SQLTemplateNOCPN3VLRSEGURO: TBCDField;
    SQLTemplateNOCPN3VLROUTRADESP: TBCDField;
    SQLTemplateNOCPN3VLRIPI: TBCDField;
    SQLTemplateNOCPN3VLRDESC: TBCDField;
    SQLTemplateCFOPA5COD: TStringField;
    SQLTemplateNOCPN3PERCICMSFRET: TBCDField;
    Label2: TLabel;
    DBEdit2: TDBEdit;
    Label3: TLabel;
    Label4: TLabel;
    ...
    SQLTemplateNOCPN3TOTDESC: TBCDField;
    SQLTemplateNOCPN3SOMAITENS: TBCDField;
    Label28: TLabel;
    ...
    SQLEstoqueAtualQTDEATUAL: TBCDField;
    ...
    TblNotaCompraNOCPN3TOTITENS: TBCDField;
    TblNotaCompraNOCPN3VLRTOTNOTA: TBCDField;
    TblNotaCompraNOCPN3VLRBASCALICM: TBCDField;
    TblNotaCompraNOCPN3VLRICMS: TBCDField;
    TblNotaCompraNOCPN3VLRBCICMSSUB: TBCDField;
    TblNotaCompraNOCPN3VLRICMSSUB: TBCDField;
    TblNotaCompraNOCPN3VLRFRETE: TBCDField;
    TblNotaCompraNOCPN3VLRSEGURO: TBCDField;
    TblNotaCompraNOCPN3VLROUTRADESP: TBCDField;
    TblNotaCompraNOCPN3VLRIPI: TBCDField;
    TblNotaCompraNOCPN3VLRDESC: TBCDField;
    TblNotaCompraCFOPA5COD: TStringField;
    TblNotaCompraNOCPN3PERCICMSFRET: TBCDField;
    TblNotaCompraNOCPA5TIPOFRETE: TStringField;
    TblNotaCompraNOCPN3TOTDESC: TBCDField;
    TblNotaCompraNOCPN3SOMAITENS: TBCDField;
    ...
    SQLNotaCompraItensNOCIN3QTDBONIF: TBCDField;
    SQLNotaCompraItensNOCIN3CAPEMBAL: TBCDField;
    SQLNotaCompraItensNOCIN3QTDEMBAL: TBCDField;
    SQLNotaCompraItensNOCIN3QTDEPED: TBCDField;
    SQLNotaCompraItensNOCIN3TOTPED: TBCDField;
    SQLNotaCompraItensNOCIN3VLRDESC: TBCDField;
    SQLNotaCompraItensNOCIN3PERCDESC: TBCDField;
    SQLNotaCompraItensNOCIN3VLRICMS: TBCDField;
    SQLNotaCompraItensNOCIN3PERCICMS: TBCDField;
    SQLNotaCompraItensNOCIN3VLRSUBST: TBCDField;
    SQLNotaCompraItensNOCIN3VLRIPI: TBCDField;
    SQLNotaCompraItensNOCIN3PERCIPI: TBCDField;
    SQLNotaCompraItensNOCIN3VLRCUSTOMED: TBCDField;
    SQLNotaCompraItensNOCIN3VLRFRETE: TBCDField;
    ...
    SQLNotaCompraItensNOCIN2ITENSENVIADOS: TBCDField;
    SQLNotaCompraItensNOCIN2VLRCOMISSAO: TBCDField;
    ...
    TblNotaCompraItemNOCIN3QTDBONIF: TBCDField;
    TblNotaCompraItemNOCIN3CAPEMBAL: TBCDField;
    TblNotaCompraItemNOCIN3QTDEMBAL: TBCDField;
    TblNotaCompraItemNOCIN3QTDEPED: TBCDField;
    TblNotaCompraItemNOCIN3TOTPED: TBCDField;
    TblNotaCompraItemNOCIN3VLREMBAL: TBCDField;
    TblNotaCompraItemNOCIN3VLRUNIT: TBCDField;
    TblNotaCompraItemNOCIN3VLRDESC: TBCDField;
    TblNotaCompraItemNOCIN3PERCDESC: TBCDField;
    TblNotaCompraItemNOCIN3VLRICMS: TBCDField;
    TblNotaCompraItemNOCIN3PERCICMS: TBCDField;
    TblNotaCompraItemNOCIN3VLRSUBST: TBCDField;
    TblNotaCompraItemNOCIN3VLRIPI: TBCDField;
    TblNotaCompraItemNOCIN3PERCIPI: TBCDField;
    TblNotaCompraItemNOCIN3VLRCUSTOMED: TBCDField;
    TblNotaCompraItemNOCIN3VLRFRETE: TBCDField;
    ...
    TblNotaCompraItemNOCIN2ITENSENVIADOS: TBCDField;
    TblNotaCompraItemNOCIN2VLRCOMISSAO: TBCDField;
    ...
    SQLParcelasCTPGN3VLR: TBCDField;
    ...
    SQLParcelasCTPGN2TOTPAG: TBCDField;
    SQLParcelasCTPGN3JUROPAGTO: TBCDField;
    SQLParcelasCTPGN3MULTAPAGTO: TBCDField;
    SQLParcelasCTPGN3DESCPAGTO: TBCDField;
    SQLParcelasCTPGN2DESCPROMO: TBCDField;
    SQLParcelasPDCPA13ID: TStringField;
    SQLParcelasCTPGCPREVREAL: TStringField;
    SQLParcelasCTPGN3TXJURO: TBCDField;
    SQLParcelasCTPGN3TXMULTA: TBCDField;
    ...
    TblNotaCompraParcelasCTPGN3VLR: TBCDField;
    ...
    TblNotaCompraParcelasCTPGN2TOTPAG: TBCDField;
    TblNotaCompraParcelasCTPGN3JUROPAGTO: TBCDField;
    TblNotaCompraParcelasCTPGN3MULTAPAGTO: TBCDField;
    TblNotaCompraParcelasCTPGN3DESCPAGTO: TBCDField;
    TblNotaCompraParcelasCTPGN2DESCPROMO: TBCDField;
    TblNotaCompraParcelasPDCPA13ID: TStringField;
    TblNotaCompraParcelasCTPGCPREVREAL: TStringField;
    TblNotaCompraParcelasCTPGN3TXJURO: TBCDField;
    TblNotaCompraParcelasCTPGN3TXMULTA: TBCDField;
    ...
    SQLNotaCompraItensNOCIN2FATOR199: TBCDField;
    SQLNotaCompraItensNOCIN2MGVENDA: TBCDField;
    SQLNotaCompraItensNOCIN2QTDENF: TBCDField;
    SQLNotaCompraItensNOCIN2VLRVENDA: TBCDField;
    SQLNotaCompraItensNOCIN2MGVENDA2: TBCDField;
    SQLNotaCompraItensNOCIN2VLRVENDA2: TBCDField;
    RDPrintRelDep: TRDprint;
    TblNotaCompraItemNOCIN2FATOR199: TBCDField;
    TblNotaCompraItemNOCIN2MGVENDA: TBCDField;
    TblNotaCompraItemNOCIN2QTDENF: TBCDField;
    TblNotaCompraItemNOCIN2VLRVENDA: TBCDField;
    TblNotaCompraItemNOCIN2MGVENDA2: TBCDField;
    TblNotaCompraItemNOCIN2VLRVENDA2: TBCDField;
    Label8: TLabel;
    EvDBNumEdit2: TEvDBNumEdit;
    SQLTemplateNOCPN3VLRISENTO: TBCDField;
    ...
    SQLNotaCompraItensNOCIN2PERCDESP: TBCDField;
    SQLNotaCompraItensNOCIN2PERCDIFICM: TBCDField;
    SQLTemplateNOCPN2VLROUTRAS: TBCDField;
    Label39: TLabel;
    EvDBNumEdit4: TEvDBNumEdit;
    MnListProdutosaltpreco: TMenuItem;
    SQLNotaCompraItensNOCIN2PERCSUBST: TBCDField;
    ...
    SQLTemplateNOCPN3VLRCOFINS: TBCDField;
    ...
    SQLTemplateNOCPN3VLRPIS: TBCDField;
    ...
    SQLNotaCompraItensNOCIN2BASECOFINS: TBCDField;
    SQLNotaCompraItensNOCIN2BASEISS: TBCDField;
    SQLNotaCompraItensNOCIN2BASEPIS: TBCDField;
    SQLNotaCompraItensNOCIN2PCREDSN: TBCDField;
    SQLNotaCompraItensNOCIN2PERCCOFINS: TBCDField;
    SQLNotaCompraItensNOCIN2PERCISS: TBCDField;
    SQLNotaCompraItensNOCIN2PERCPIS: TBCDField;
    SQLNotaCompraItensNOCIN2PMVAST: TBCDField;
    SQLNotaCompraItensNOCIN2PREDBC: TBCDField;
    SQLNotaCompraItensNOCIN2PREDBCST: TBCDField;
    SQLNotaCompraItensNOCIN2VBC: TBCDField;
    SQLNotaCompraItensNOCIN2VBCIPI: TBCDField;
    SQLNotaCompraItensNOCIN2VBCST: TBCDField;
    SQLNotaCompraItensNOCIN2VBCSTRET: TBCDField;
    SQLNotaCompraItensNOCIN2VCREDICMSSN: TBCDField;
    SQLNotaCompraItensNOCIN2VICMSSTRET: TBCDField;
    SQLNotaCompraItensNOCIN2VLRCOFINS: TBCDField;
    SQLNotaCompraItensNOCIN2VLRDESPESAS: TBCDField;
    SQLNotaCompraItensNOCIN2VLRISS: TBCDField;
    SQLNotaCompraItensNOCIN2VLRPIS: TBCDField;
    SQLNotaCompraItensNOCIN2VLRSEGURO: TBCDField;
    SQLNotaCompraItensNOCN4COFINSQTD: TBCDField;
    SQLNotaCompraItensNOCN4COFINSREAL: TBCDField;
    SQLNotaCompraItensNOCN4PISQTD: TBCDField;
    SQLNotaCompraItensNOCN4PISREAL: TBCDField;
    SQLNotaCompraItensNOCN4QTDIPI: TBCDField;
    SQLNotaCompraItensNOCN4UNDIPI: TBCDField;
    ...
    SQLNotaCompraItensNOCIN3PERCFRETE: TBCDField;
...
begin
  ...
  SQLTemplateOPESICOD.AsVariant       := Dm.SQLConfigCompraCFCOITIPMOVNFE.AsVariant;
    ...
    If DM.SQLTemplate.FindField('EMPRICODDEST').asInteger = EmpresaCorrente Then
      If DM.SQLTemplate.FindField('PDCPCSTATUS').asString = 'E' Then
        Begin
          ...
          if (DM.SQLConfigCompraCFCOCNIMPFINPEDCOMP.AsString = 'S') then
            ImportandoPedido := False
          else
...
begin
  ...
  If (StatusNovo = 'E') Then
    Begin
      ...
      if SQLTemplateOPESICOD.AsInteger > 0 then
        begin
          if DM.SQLConfigCompraCFCOITIPMOVNFE.Value <= 0 then
            OperacaoEstoque := SQLTemplateOPESICOD.AsInteger
          else
            if DM.SQLConfigCompraCFCOITIPMOVNFE.Value <> SQLTemplateOPESICOD.AsInteger then
              OperacaoEstoque := SQLTemplateOPESICOD.AsInteger
            else
              OperacaoEstoque := DM.SQLConfigCompraCFCOITIPMOVNFE.Value;
        end
      else
        OperacaoEstoque := DM.SQLConfigCompraCFCOITIPMOVNFE.Value;
            ...
            begin
              TRY
               ...
               if SQLLocate('OPERACAOESTOQUE','OPESICOD','OPESCENTRADASAIDA',IntToStr(OperacaoEstoque)) = 'E' then
                ...
                if DM.SQLConfigCompraCFCOCVERIFICAVLRMENOR.AsString <> 'S' then
                  begin
                    if (MatrizFilial = 'M') then
                      if SQLLocate('OPERACAOESTOQUE','OPESICOD','OPESCGERAFINANCEIRO',IntToStr(OperacaoEstoque)) = 'S' then
                        if (DM.SQLConfigCompraCFCOCALTVLRCOMPRA.Value = 'S') and
                  ...
                  begin
                    if (MatrizFilial = 'M') then
                      if (DM.SQLConfigCompraCFCOCVERIFICAVLRMENOR.AsString = 'S') and
                         (SQLLocate('OPERACAOESTOQUE','OPESICOD','OPESCENTRADASAIDA',IntToStr(OperacaoEstoque)) = 'E') then
                        begin
                          if SQLLocate('OPERACAOESTOQUE','OPESICOD','OPESCGERAFINANCEIRO',IntToStr(OperacaoEstoque)) = 'S' then
                ...
                if DM.SQLConfigCompraCFCOCVERIFICAVLRMENOR.AsString <> 'S' then
                  begin
                    if (MatrizFilial = 'M') then
                      if SQLLocate('OPERACAOESTOQUE','OPESICOD','OPESCGERAFINANCEIRO',IntToStr(OperacaoEstoque)) = 'S' then
                        if (DM.SQLConfigCompraCFCOCALTVLRCUSTO.Value = 'S') and
                           (SQLLocate('OPERACAOESTOQUE','OPESICOD','OPESCENTRADASAIDA',IntToStr(OperacaoEstoque)) = 'E') then
                ...
                if (MatrizFilial = 'M') then
                  if SQLLocate('OPERACAOESTOQUE','OPESICOD','OPESCGERAFINANCEIRO',IntToStr(OperacaoEstoque)) = 'S' then
                    if (DM.SQLConfigCompraCFCOCALTPERCIPI.Value = 'S') then
                      begin
                        // IPI Percentual
                ...
                if (MatrizFilial = 'M') then
                  if SQLLocate('OPERACAOESTOQUE','OPESICOD','OPESCGERAFINANCEIRO',IntToStr(OperacaoEstoque)) = 'S' then
                    if (DM.SQLConfigCompraCFCOCALTPRCPRODENT.Value = 'S') and
                       (SQLLocate('OPERACAOESTOQUE','OPESICOD','OPESCENTRADASAIDA',IntToStr(OperacaoEstoque)) = 'E') then
                      begin
      ...
      If (DM.SQLConfigCompraCFCOCEXCLUIPEDENT.asString='S') and (SQLTemplatePDCPA13ID.AsVariant<>Null) Then
        Begin
  ...
  If (StatusNovo = 'C') Then
    Begin
      ...
      if SQLTemplateOPESICOD.AsInteger > 0 then
        begin
          if DM.SQLConfigCompraCFCOITIPMOVCANCNFE.Value <= 0 then
            OperacaoEstoque := SQLTemplateOPESICOD.AsInteger
          else
            OperacaoEstoque := DM.SQLConfigCompraCFCOITIPMOVCANCNFE.Value;
        end
      else
        OperacaoEstoque := DM.SQLConfigCompraCFCOITIPMOVCANCNFE.Value;
...
begin
  ...
  if DM.SQLConfigCompraPORTICOD.AsInteger > 0 then
    SQLParcelasPORTICOD.AsString := DM.SQLConfigCompraPORTICOD.AsString;
  if DM.SQLConfigCompraTPDCICOD.AsInteger > 0 then
    SQLParcelasTPDCICOD.AsString := DM.SQLConfigCompraTPDCICOD.AsString;
end;
