...
type
  TFormTelaImportacaoPedidoCompra = class(TFormTelaGeralTEMPLATE)
    ...
    SQLTemplatePCITN3QTDBONIF: TBCDField;
    SQLTemplatePCITN3CAPEMBAL: TBCDField;
    SQLTemplatePCITN3QTDEMBAL: TBCDField;
    SQLTemplatePCITN3QTDENTR: TBCDField;
    SQLTemplatePCITN3VLREMBAL: TBCDField;
    SQLTemplatePCITN3VLRUNIT: TBCDField;
    SQLTemplatePCITN3PERVIPI: TBCDField;
    SQLTemplatePCITN3VLRIPI: TBCDField;
    SQLTemplatePCITN3VLRICM: TBCDField;
    SQLTemplatePCITN3PERICM: TBCDField;
    SQLTemplatePCITN3PERCDESC: TBCDField;
    SQLTemplatePCITN3VLRDESC: TBCDField;
    ...
    TblQtdePCITN3QTDBONIF: TBCDField;
    TblQtdePCITN3PERICM: TBCDField;
    TblQtdePCITN3PERCDESC: TBCDField;
