...
begin
    Linha := 1;
    rdp.Abrir;
    rdp.ImpF(Linha,1,'Supermercado REDE AMMPA',[Expandido, Normal]); Inc(Linha,2);
    rdp.Imp(Linha, 1,'Rua Sao Franscisco, 161'); Inc(Linha,1);
    ...
    rdp.ImpVal(Linha,39,'##0.00',(TblPedidoTotal.Value-TblPedidoTotalDesconto.Value),[]);  Inc(Linha,3);
    rdp.Imp(Linha,1,'Obrigado! Volte Sempre!'); Inc(Linha,1);
