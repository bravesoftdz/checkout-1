...
begin
  ...
  try
    ...
    TblPedido.Open;
    TblPedido.Append;
    TblPedidoPEDIDOORCAMENTO.AsString        := 'PRE VENDA';
    TblPedidoPedICod.AsString                := '001'+FormatFloat('000',TblPreVendaCabTERMICOD.AsFloat)+
                                                FormatFloat('0000000',TblPreVendaCabTicketNumero.AsFloat);
    ...
    While Not TblPreVendaItem.Eof Do
      Begin
        ...
        TblPedidoItemPedICod.Value     := TblPedidoPedICod.AsString;
...
begin
    Linha := 1;
    RDprint.Abrir;
    RDprint.ImpF(Linha, 1,'CRIACOES DARVAMI',[Expandido, Italico]); Inc(Linha,2);
    RDprint.ImpF(Linha, 1,'RUA GARIBALDI, 240 - CENTRO - ESTEIO',[Normal]); Inc(Linha);
    RDprint.ImpF(Linha, 1,'Fone/Fax.: 51 3473 2538 / 51 3473 2078',[Normal]);
    RDprint.ImpF(Linha,50,TblPedidoPEDIDOORCAMENTO.AsString,[Normal]); Inc(Linha,2); // PRE VENDA
    ...
    While not TblPedidoItem.eof Do
      Begin
        ...
        if TblPedidoItemTroca.value = 'S' then
          RDprint.Imp(Linha,21,'(T)'+TblPedidoItemDescricao.AsString)
        else
          RDprint.Imp(Linha,21,TblPedidoItemDescricao.AsString);
