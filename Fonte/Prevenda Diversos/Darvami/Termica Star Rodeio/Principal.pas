...
type
  TFormPrincipal = class(TForm)
    ...
    TblPedidoTotalLiq: TFloatField;
    BDEPipeppField36: TppField;
...
begin
  try
    ...
    TblPedidoPedICod.AsString := copy(TblPreVendaCabTicketNumero.AsString,5,2) +'.'+
                                 copy(TblPreVendaCabTicketNumero.AsString,8,5);
    ...
    TblPedidoTotal.Value                     := TblPreVendaCabTotalGeral.Value+TblPreVendaCabDesconto.Value;
    TblPedidoTotalLiq.Value                  := TblPreVendaCabTotalGeral.Value;
    ...
    While Not TblPreVendaItem.Eof Do
      Begin
        ...
        TblPedidoItemDescricao.Value   := TblPreVendaItemDescricao.Value; { dm.SQLLocate('PRODUTO','PRODICOD','PRODA60DESCR',TblPreVendaItemCodigo.AsString); }
    ...
    // Deixa apenas itens com troca para usar depois na impressao
    // Testa se tem  Troca
    TblPreVendaItem.First;
{    While not TblPreVendaItem.eof Do
      Begin
        if TblPreVendaItemTroca.value <> 'S' then
          TblPreVendaItem.Delete
        else
          TblPreVendaItem.Next;
      End;}
