...
//    TblPedidoTipoVenda.asString              := TblPreVendaCabTipoVenda.AsString;
    ...
    Linha := 1;
    rdp.Abrir;
    rdp.ImpF(Linha, 1,'BSD GRAVATAI SISTEMA DE SEGURANCA',[Expandido, Italico]); Inc(Linha,2);
    rdp.ImpF(Linha, 1,'ESTRADA RS 020, 730 - VERA CRUZ - GRAVATAI/RS',[Normal]); Inc(Linha);
    rdp.ImpF(Linha, 1,'Fone/Fax.: 51 3490 2861',[Normal]); Inc(Linha,2);
    rdp.Imp(Linha,  1,'PEDIDO.....: '  + TblPedidoPedICod.AsString);
    rdp.Imp(Linha, 60,'Data.....: '    + FormatDateTime('dd/mm/yy hh:mm',TblPreVendaCabDataEmissao.Value)); Inc(Linha,2);
    rdp.Imp(Linha,  1,'Cliente....: '  + TblPedidoDestinatario_Nome.AsString); Inc(Linha);
    rdp.Imp(Linha,  1,'Endereco...: '  + TblPedidoDestinatario_Endereco.AsString);
    rdp.Imp(Linha, 60,'Cidade...: '    + TblPedidoDestinatario_Cidade.AsString+'/'+TblPedidoDestinatario_UF.AsString); Inc(Linha);
    rdp.Imp(Linha,  1,'CPF/CNPJ...: '  + TblPedidoDestinatario_CpfCgc.AsString);
    rdp.Imp(Linha, 60,'RG/IE....: '    + TblPedidoDestinatario_IE.AsString); Inc(Linha);
    rdp.Imp(Linha,  1,'Fone.......: '  + TblPedidoDestinatario_Fone.AsString);
    rdp.Imp(Linha, 35,'Fax.: '         + TblPedidoDestinatario_Fax.AsString);
    rdp.Imp(Linha, 60,'Vendedor.: '    + TblPedidoVendedor.AsString); Inc(Linha);
    rdp.Imp(Linha,  1,'Observacao.: '  + TblPedidoObservacoes.Value);  Inc(Linha,2);
    rdp.Imp(Linha,  1,'Plano Pgto.: '  + TblPedidoPlano.AsString); Inc(Linha);
      ...
      Begin
        if TblPedidoItemTroca.value <> 'S' then
          begin
            ...
            rdp.ImpVal(Linha,30,'##0.00',(TblPedidoItemVlrUnitario.Value-TblPedidoItemDesconto.Value),[]);
    ...
    rdp.ImpVal(Linha,39,'##0.00',(TblPedidoTotalDesconto.Value+TotDesc),[]);  Inc(Linha);
    ...
    rdp.Imp(Linha, 1,'         Obrigado! Volte Sempre!             '); Inc(Linha);
    rdp.Imp(Linha,1,'----------------------------------------------'); Inc(Linha,1);
