...
//    TblPedidoTipoVenda.asString              := TblPreVendaCabTipoVenda.AsString;
    ...
    Linha := 1;
    rdp.Abrir;
    rdp.ImpF(Linha,1,' MERCADO SERRANO',[Expandido, Normal]); Inc(Linha,2);
    rdp.Imp(Linha, 1,'     33.009.911/0047-11 - 1170156051'); Inc(Linha,1);
    rdp.Imp(Linha, 1,'Fone 51 3439.1005'); Inc(Linha,2);
    rdp.ImpF(Linha,1,'       C U P O M ',[Expandido, Normal]); Inc(Linha);
