...
begin
    Linha := 1;
    rdp.Abrir;
    rdp.ImpF(Linha,1,'SUPER CERTO',[Expandido, Normal]); Inc(Linha,1);
    rdp.Imp(Linha, 1,'AV. PARAGUASSU, 444       CAPAO DA CANOA - RS'); Inc(Linha,2);
    rdp.Imp(Linha, 1,'Controle.: '  + TblPedidoPedICod.AsString + '  Data: '  + TblPedidoDtEmissao.AsString); Inc(Linha,1);
