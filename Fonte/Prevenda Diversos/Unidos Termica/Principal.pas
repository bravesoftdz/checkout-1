...
//    TblPedidoTipoVenda.asString              := TblPreVendaCabTipoVenda.AsString;
    ...
    Linha := 1;
    rdp.Abrir;
    rdp.ImpF(Linha,1,' UNIDOS CONSTR. E MOVEIS',[Expandido, Normal]); Inc(Linha,2);
    rdp.Imp(Linha, 1,'      94.549.045/0001-63   057/0117461'); Inc(Linha,1);
    rdp.Imp(Linha, 1,'Fone 51 3490.2567'); Inc(Linha,2);
    rdp.ImpF(Linha,1,'       P E D I D O',[Expandido, Normal]); Inc(Linha);
    rdp.Imp(Linha, 1,'Controle....: '  + TblPedidoPedICod.AsString); Inc(Linha,1);
    rdp.Imp(Linha, 1,'Data Ped....: '  + TblPedidoDtEmissao.AsString); Inc(Linha,1);
    rdp.Imp(Linha, 1,'Emitido em..: '  + FormatDateTime('dd/mm/yy hh:nn:ss', now)); Inc(Linha,2);
