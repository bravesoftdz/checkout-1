...
begin
    Linha := 3;
    RDprint.Abrir;
    RDprint.ImpF(Linha, 1,'MARLENE ISOLINA DOS SANTOS',[Expandido, Italico]); Inc(Linha,2);
    RDprint.ImpF(Linha, 1,'AV MILITAO DE ALMEIDA 147 - CENTRO - TRAMANDAI - RS',[Normal]); Inc(Linha);
    RDprint.ImpF(Linha, 1,'Fone/Fax.: 51 3684 4520',[Normal]);
