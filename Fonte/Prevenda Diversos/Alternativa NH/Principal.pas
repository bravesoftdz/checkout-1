...
begin
  try
    ...
    Linha := 1;
    rdp.Abrir;
    rdp.ImpF(Linha,1,'Alternativa Modas',[Expandido, Normal]); Inc(Linha,2);
    rdp.Imp(Linha, 1,'Rua Bartolomeu Gusmao, 2056 - NH'); Inc(Linha,1);
    rdp.Imp(Linha, 1,'Fone 51 3582.3594'); Inc(Linha,2);
