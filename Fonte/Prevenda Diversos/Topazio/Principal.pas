...
begin
  try
    ...
    Linha := 1;
    rdp.Abrir;
    rdp.ImpF(Linha,1,'Topazio',[Expandido, Normal]); Inc(Linha,2);
    rdp.Imp(Linha, 1,'Rua Fernando Amaral, 168 - Lj.01'); Inc(Linha,1);
    rdp.Imp(Linha, 1,'Fone 51 3661.3138'); Inc(Linha,2);
