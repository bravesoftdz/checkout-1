...
begin
  try
    ...
    rdp.Abrir;
    Linha := 1;
    rdp.Imp(Linha,1,'SAPORE DI CASA'); Inc(Linha);
    rdp.Imp(Linha,1,'RUA ALEGRETE, 1847'); Inc(Linha);
    rdp.Imp(Linha,1,'9205.3353 Claro'); Inc(Linha);
    rdp.Imp(Linha,1,'9929.5256 Vivo'); Inc(Linha);
    rdp.Imp(Linha,1,'8180.1777 TIM'); Inc(Linha);
    ...
    rdp.ImpVal(Linha,30,'##0.00',TblPreVendaCabTroco.Value,[]);  Inc(Linha,5);
