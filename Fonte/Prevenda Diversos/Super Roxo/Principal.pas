...
//    TblPedidoTipoVenda.asString              := TblPreVendaCabTipoVenda.AsString;
    ...
    Linha := 1;
    rdp.Abrir;
    rdp.ImpF(Linha,1,'    SUPERMERCADO ROXO',[Expandido, Normal]); Inc(Linha,2);
    rdp.Imp(Linha, 1,'          RUA LAJEADO 347 - GRAVATAI/RS'); Inc(Linha,1);
    rdp.Imp(Linha, 1,'                  51 3423.2769'); Inc(Linha,2);
