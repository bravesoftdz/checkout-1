object FormPrincipal: TFormPrincipal
  ...
  object rdp: TRDprint
    ...
    OpcoesPreview.CaptionPreview = 'Impressao Cozinha'
  ...
  object SQLCozinha: TRxQuery
    DatabaseName = 'UnitGestao_Temp'
    SQL.Strings = (
      'Select * from TicketPreVendaItem'
      'Where %Filtro')
    Macros = <
      item
        DataType = ftString
    ...
    Left = 107
    Top = 68
    object SQLCozinhaCodigo: TIntegerField
      FieldName = 'Codigo'
      Origin = 'UNITGESTAO_TEMP."TicketPreVendaItem.DB".Codigo'
    end
    object SQLCozinhaDescricao: TStringField
      FieldName = 'Descricao'
      Origin = 'UNITGESTAO_TEMP."TicketPreVendaItem.DB".Descricao'
      Size = 30
    end
    object SQLCozinhaComplemento: TStringField
      FieldName = 'Complemento'
      Origin = 'UNITGESTAO_TEMP."TicketPreVendaItem.DB".Complemento'
      Size = 60
    end
    object SQLCozinhaQuantidade: TFloatField
      FieldName = 'Quantidade'
      Origin = 'UNITGESTAO_TEMP."TicketPreVendaItem.DB".Quantidade'
    end
    object SQLCozinhaValorUnitario: TFloatField
      FieldName = 'ValorUnitario'
      Origin = 'UNITGESTAO_TEMP."TicketPreVendaItem.DB".ValorUnitario'
    end
    object SQLCozinhaValorTotal: TFloatField
      FieldName = 'ValorTotal'
      Origin = 'UNITGESTAO_TEMP."TicketPreVendaItem.DB".ValorTotal'
    end
    object SQLCozinhaDesconto: TFloatField
      FieldName = 'Desconto'
      Origin = 'UNITGESTAO_TEMP."TicketPreVendaItem.DB".Desconto'
    end
    object SQLCozinhaMarca: TStringField
      FieldName = 'Marca'
      Origin = 'UNITGESTAO_TEMP."TicketPreVendaItem.DB".Marca'
      Size = 15
    end
    object SQLCozinhaReferencia: TStringField
      FieldName = 'Referencia'
      Origin = 'UNITGESTAO_TEMP."TicketPreVendaItem.DB".Referencia'
      Size = 15
    end
    object SQLCozinhaTroca: TStringField
      FieldName = 'Troca'
      Origin = 'UNITGESTAO_TEMP."TicketPreVendaItem.DB".Troca'
      Size = 1
    end
    object SQLCozinhaImpCozinha: TStringField
      FieldName = 'ImpCozinha'
      Origin = 'UNITGESTAO_TEMP."TicketPreVendaItem.DB".ImpCozinha'
      Size = 1
    end
    object SQLCozinhaImpVale: TStringField
      FieldName = 'ImpVale'
      Origin = 'UNITGESTAO_TEMP."TicketPreVendaItem.DB".ImpVale'
      Size = 1
    end
    object SQLCozinhaPRODA30COZINHA: TStringField
      FieldName = 'PRODA30COZINHA'
      Origin = 'UNITGESTAO_TEMP."TicketPreVendaItem.DB".PRODA30COZINHA'
      Size = 30
    end
  end
end
