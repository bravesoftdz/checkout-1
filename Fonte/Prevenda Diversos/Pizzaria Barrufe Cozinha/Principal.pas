...
type
  TFormPrincipal = class(TForm)
    ...
    SQLCozinha: TRxQuery;
    SQLCozinhaCodigo: TIntegerField;
    SQLCozinhaDescricao: TStringField;
    SQLCozinhaComplemento: TStringField;
    SQLCozinhaQuantidade: TFloatField;
    SQLCozinhaValorUnitario: TFloatField;
    SQLCozinhaValorTotal: TFloatField;
    SQLCozinhaDesconto: TFloatField;
    SQLCozinhaMarca: TStringField;
    SQLCozinhaReferencia: TStringField;
    SQLCozinhaTroca: TStringField;
    SQLCozinhaImpCozinha: TStringField;
    SQLCozinhaImpVale: TStringField;
    SQLCozinhaPRODA30COZINHA: TStringField;
      ...
      begin
            ...
            if TicketItemImpCozinha.value = 'S' then
              begin
                if TicketItemPRODA30COZINHA.Value = 'Cozinha01' then
                  begin ImpCozinha1 := True; ImpCozinha3 := True; end;
                if TicketItemPRODA30COZINHA.Value = 'Cozinha02' then ImpCozinha2 := True;
                // Foi comentado para poder imprimir em mais de uma impressora os produtos apontados para cozinha01
        ...
        if (ImpCozinha1) or (ImpCozinha2) or (ImpCozinha3) then
          begin
            ...
            SQLCozinha.Close;
            SQLCozinha.MacroByName('Filtro').Value := 'PRODA30COZINHA = "Cozinha01"';
            SQLCozinha.Open;
            if (ImpCozinha1) and (ImpressoraCozinha01 <> '') and (not SQLCozinha.IsEmpty) then
              begin
                ...
                rdp.Imp(Linha, 1,'Cozinha01'); Inc(Linha,1);
            ...
            // Se a var for true e tiver impressora cadastrada no Parceiro.txt, tenta imprimir
            SQLCozinha.Close;
            SQLCozinha.MacroByName('Filtro').Value := 'PRODA30COZINHA = "Cozinha02"';
            SQLCozinha.Open;
            if (ImpCozinha2) and (ImpressoraCozinha02 <> '') and (not SQLCozinha.IsEmpty) then
              begin
                rdp.PortaComunicacao := '';
                ...
                Inc(Linha,1);
                rdp.Imp(Linha, 1,'Data........: '  + FormatDateTime('dd/mm/yy hh:nn:ss',now)); Inc(Linha,2);
                rdp.Imp(Linha, 1,'Cozinha02'); Inc(Linha,1);
                rdp.Imp(Linha, 1,'----------------------------------------------'); Inc(Linha,1);
                rdp.Imp(Linha, 1,'Qtd Descricao                                 '); Inc(Linha);
                rdp.Imp(Linha, 1,'----------------------------------------------'); Inc(Linha,1);
                TicketItem.First;
            ...
            // Se a var for true e tiver impressora cadastrada no Parceiro.txt, tenta imprimir uma copia do pedido em outra impressora da cozinha!
            SQLCozinha.Close;
            SQLCozinha.MacroByName('Filtro').Value := 'PRODA30COZINHA = "Cozinha01"';
            SQLCozinha.Open;
            if (ImpCozinha3) and (ImpressoraCozinha03 <> '') and (not SQLCozinha.IsEmpty) then
              begin
                rdp.PortaComunicacao := '';
                ...
                Inc(Linha,1);
                rdp.Imp(Linha, 1,'Data........: '  + FormatDateTime('dd/mm/yy hh:nn:ss',now)); Inc(Linha,2);
                rdp.Imp(Linha, 1,'Cozinha03'); Inc(Linha,1);
                rdp.Imp(Linha, 1,'----------------------------------------------'); Inc(Linha,1);
                rdp.Imp(Linha, 1,'Qtd Descricao                                 '); Inc(Linha);
                rdp.Imp(Linha, 1,'----------------------------------------------'); Inc(Linha,1);
                TicketItem.First;
