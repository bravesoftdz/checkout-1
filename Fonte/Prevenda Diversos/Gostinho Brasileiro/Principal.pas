...
//    TblPedidoTipoVenda.asString              := TblPreVendaCabTipoVenda.AsString;
    ...
    Linha := 1;
    rdp.Abrir;
    rdp.ImpF(Linha,1,' GOSTINHO BRASILEIRO',[Expandido, Normal]); Inc(Linha,2);
    rdp.Imp(Linha, 1,'       AV.FRED. RITTER, 7001 - CACHOEIRINHA/RS'); Inc(Linha,1);
    rdp.Imp(Linha, 1,'        10.657.363/0001-58   -    1770187798'); Inc(Linha,2);
