          ...
          begin
            ...
            if (ImpCozinha1) and (ImpressoraCozinha01 <> '') then
              ...
              {  Inc(Linha,5);
                ...
                rdp.gerarTXT('c:\unit\Cozinha01.txt');
                rdp.Abortar;
                if FileExists('c:\Unit\Cozinha01.txt') then
                  WinExec( Pchar('notepad.exe /pt "c:\Unit\Cozinha01.txt" '+'"'+ImpressoraCozinha01+'"'), SW_MINIMIZE); }
