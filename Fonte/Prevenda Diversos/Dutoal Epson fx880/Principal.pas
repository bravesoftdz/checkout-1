...
begin
  ...
  Linha := 1;
  RDprint.Abrir;
  RDprint.ImpF(Linha, 1,'DUTOAL COMERCIO DE ALUMINIOS E METAIS LTDA',[Expandido, Italico]); Inc(Linha,2);
  RDprint.ImpF(Linha, 1,'CNPJ: 04.908.621/0001-29               Insc. Estadual: 281/0021281',[Normal]); Inc(Linha);
  RDprint.ImpF(Linha, 1,'AV PARAGUASSU, 3264 - COURASA - IMBE',[Normal]); Inc(Linha);
  RDprint.ImpF(Linha, 1,'Fone: 51 3627 1000                     Fax: 51 3627 4966',[Normal]); Inc(Linha,2);

  if TblPreVendaCabDisplayNumero.Value>0 then
    RDprint.Imp(Linha, 1,'Controle....: '  + TblPreVendaCabDisplayNumero.AsString)
  else
