...
begin
  try
    ...
    rdp.Abrir;
    rdp.ImpF(Linha, 1,EmpresaNome,[Expandido, Italico]); Inc(Linha,2);
    rdp.ImpF(Linha, 1,EmpresaEndereco,[Normal]); Inc(Linha);
    rdp.ImpF(Linha, 1,EmpresaFone,[Normal]);     Inc(Linha,2);
      ...
      Begin
        if TblPreVendaItemTroca.value <> 'S' then
          begin
            ...
            rdp.Imp(Linha, 8,copy(TblPreVendaItemDescricao.AsString,1,45));
    ...
    rdp.Imp(Linha,60,'Total Geral R$');
          ...
          While not TblPreVendaItem.eof Do
            Begin
              if TblPreVendaItemTroca.value <> 'S' then
                begin
                  rdp.Imp(Linha, 1,FormatFloat('######000000',TblPreVendaItemCodigo.Value));
                  rdp.Imp(Linha, 8,copy(TblPreVendaItemDescricao.AsString,1,35));
                  rdp.ImpVal(Linha,59,'##0.00',TblPreVendaItemQuantidade.Value,[]);
                  rdp.ImpVal(Linha,67,'##0.00',TblPreVendaItemValorUnitario.Value,[]);
                  rdp.ImpVal(Linha,77,'##0.00',TblPreVendaItemDesconto.Value,[]);
                  rdp.ImpVal(Linha,88,'##0.00',TblPreVendaItemValorTotal.Value,[]); Inc(Linha);
