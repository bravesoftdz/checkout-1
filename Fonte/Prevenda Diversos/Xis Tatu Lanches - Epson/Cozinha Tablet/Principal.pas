          ...
          begin
            ...
            if (ImpCozinha1) and (ImpressoraCozinha01 <> '') then
              begin
                ...
                rdp.gerarTXT('c:\Easy2Solutions\CozinhaTablet01.txt');
                rdp.Abortar;
              {  arq_new := 'c:\unit\ImpCozinha_Mesa_'+TicketCabMesaCodigo.AsString+'_Comanda_'+TicketCabContaCodigo.AsString+'_Pedido_'+TicketCabTicketNumero.AsString+'.txt';
                CopyFile(pchar('c:\unit\ImprimirCozinha.txt'),pchar(arq_new),true);}
                if FileExists('c:\Easy2Solutions\CozinhaTablet01.txt') then
                  WinExec( Pchar('notepad.exe /pt "c:\Easy2Solutions\CozinhaTablet01.txt" '+'"'+ImpressoraCozinha01+'"'), SW_MINIMIZE);
            ...
            if (ImpCozinha2) and (ImpressoraCozinha02 <> '') then
              begin
                ...
                rdp.Imp(Linha, 1,'---Final Pedido---'); Inc(Linha);
                rdp.TamanhoQteLinhas := Linha+5;
                rdp.gerarTXT('c:\Easy2Solutions\CozinhaTablet02.txt');
                rdp.Abortar;
                if FileExists('c:\Easy2Solutions\CozinhaTablet02.txt') then
                  WinExec( Pchar('notepad.exe /pt "c:\Easy2Solutions\CozinhaTablet02.txt" '+'"'+ImpressoraCozinha02+'"'), SW_MINIMIZE);
              end;
            ...
            if (ImpCozinha3) and (ImpressoraCozinha03 <> '') then
              begin
                ...
                rdp.Imp(Linha, 1,'---Final Pedido---'); Inc(Linha);
                rdp.TamanhoQteLinhas := Linha+5;
                rdp.gerarTXT('c:\Easy2Solutions\CozinhaTablet03.txt');
                rdp.Abortar;
                if FileExists('c:\Easy2Solutions\CozinhaTablet03.txt') then
                  WinExec( Pchar('notepad.exe /pt "c:\Easy2Solutions\CozinhaTablet03.txt" '+'"'+ImpressoraCozinha03+'"'), SW_MINIMIZE);
              end;
            ...
            if (ImpCozinha4) and (ImpressoraCozinha04 <> '') then
              begin
                ...
                rdp.Imp(Linha, 1,'---Final Pedido---'); Inc(Linha);
                rdp.TamanhoQteLinhas := Linha+5;
                rdp.gerarTXT('c:\Easy2Solutions\CozinhaTablet04.txt');
                rdp.Abortar;
                if FileExists('c:\Easy2Solutions\CozinhaTablet04.txt') then
                  WinExec( Pchar('notepad.exe /pt "c:\Easy2Solutions\CozinhaTablet04.txt" '+'"'+ImpressoraCozinha04+'"'), SW_MINIMIZE);
              end;
            ...
            if (ImpCozinha5) and (ImpressoraCozinha05 <> '') then
              begin
                ...
                rdp.Imp(Linha, 1,'---Final Pedido---'); Inc(Linha);
                rdp.TamanhoQteLinhas := Linha+5;
                rdp.gerarTXT('c:\Easy2Solutions\CozinhaTablet05.txt');
                rdp.Abortar;
                if FileExists('c:\Easy2Solutions\CozinhaTablet05.txt') then
                  WinExec( Pchar('notepad.exe /pt "c:\Easy2Solutions\CozinhaTablet05.txt" '+'"'+ImpressoraCozinha05+'"'), SW_MINIMIZE);
              end;
