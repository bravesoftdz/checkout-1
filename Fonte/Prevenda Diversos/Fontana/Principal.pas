...
{    If TblPedidoFinanceiro.Exists Then
    ...
    While Not TblPreVendaFin.Eof Do
      Begin
        ...
        TblPedidoFinanceiroValorN.Value      := TblPreVendaFinValor.Value;
...
begin
    Linha := 1;
    RDprint.Abrir;
    RDprint.ImpF(Linha, 1,'WALDEMAR SCHMIDT MAT CONSTRUCAO',[Expandido, Italico]); Inc(Linha,2);
    RDprint.ImpF(Linha, 1,'AV JOAO PAULO I N.488 - SANTO INACIO - ESTEIO',[Normal]); Inc(Linha);
    RDprint.ImpF(Linha, 1,'Fone/Fax.: 51 3473-1142',[Normal]);
    ...
    RDprint.ImpVal(Linha,71,'###,##0.00',TblPedidoTotal.Value,[]);    Inc(Linha);
    ...
    RDprint.ImpVal(Linha,71,'###,##0.00',(TblPedidoTotal.Value-TblPedidoTotalDesconto.Value),[]);  Inc(Linha,2);
