...
type
  TFormCadastroMecOrdem = class(TFormCadastroTEMPLATE)
    ...
    SQLTemplateORITN2VLRPRODUTO: TBCDField;
    SQLTemplateORITN2VLRSERVICO: TBCDField;
    ...
    SQLVeiculosVICLN2KMATUAL: TBCDField;
    ...
    SQLFinanceiroPLRCN2TXJURO: TBCDField;
    SQLFinanceiroPLRCN2TXMULTA: TBCDField;
    SQLFinanceiroPLRCN2TXCRED: TBCDField;
    SQLFinanceiroPLRCN2PERCDESC: TBCDField;
    ...
    SQLFinanceiroPLRCN2PERCENTR: TBCDField;
    SQLFinanceiroPLRCN2DESC: TBCDField;
    SQLFinanceiroPLRCCATIVO: TStringField;
    SQLFinanceiroPENDENTE: TStringField;
    SQLFinanceiroREGISTRO: TDateTimeField;
    SQLFinanceiroPLRCN2PERCACRESC: TBCDField;
    SQLFinanceiroPLRCCIMPDESCRNF: TStringField;
    SQLFinanceiroPLRCN5FATOR: TBCDField;
    SQLFinanceiroPLRCN5FATORPARC: TBCDField;
    SQLFinanceiroPLRCFATCASH: TStringField;
    SQLFinanceiroPLRCN2PERCJURDIA: TBCDField;
...
begin
  ...
  UFEmpresa := SQLLocate('EMPRESA','EMPRICOD','EMPRA2UF',DM.SQLTerminalAtivoEMPRICOD.AsString);
...
//  SQLNotaFiscalNOFIN3QUANT.Value       := QtdeTotal;
  ...
  if DM.SQLConfigVendaCFVETOBSPADRAONF.AsString <> '' then
    SQLNotaFiscalNOFIA255OBS.AsString := DM.SQLConfigVendaCFVETOBSPADRAONF.AsString+ '  '+Dm.PedidoObs;
  ...
  begin
    ...
    While Not SQLParcelasPrazoVendaTemp.Eof Do
      Begin
        ...
        SQLContasReceberTPDCICOD.AsVariant     := dm.SQLConfigVendaTPDCICOD.AsString;
        SQLContasReceberPORTICOD.asVariant     := dm.SQLConfigVendaPORTICOD.AsString;
