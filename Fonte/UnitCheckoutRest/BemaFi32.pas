 ...
 {Parâmetros da DLL:
  ...
  if Frac(Quantidade) > 0 then
    begin
      ...
      if Bematech_FI_VendeItem(copy(Codigo,1,13),copy(Descricao,1,29),Aliquota,Tipo_de_Quantidade,Quantidade_ECF,dm.SQLTerminalAtivoTERMINRODECVALORUNIT.AsInteger,Valor_Unitario_ECF,Tipo_de_Desconto,Valor_Desconto_ECF) = 1 then
        Result := True
      else
        Result := False;
    end
