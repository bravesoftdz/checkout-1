...
begin
    ...
    if not SQLPlanoRecebimento.EOF then
      begin
        ...
        FormTelaFechamentoVenda.ValorTotalVenda.Value := (FormTelaItens.ValorSubTotal + FormTelaFechamentoVenda.VlrTele.Value) ;
        ...
        CriaParcelas(SQLParcelasPrazoVendaTemp,
                     ...
                     Date,
                     'TpRecVistaTel', 'TpRecPrazoTel',Dm.SQLTerminalAtivoTERMINUMEVISTA.AsString , Dm.SQLTerminalAtivoTERMINUMEPRAZO.AsString, 'Documento',
                     ValorDiminuirAcresc,
                     VlrJuro,
                     VlrAcresc,
                     VlrEntr,
