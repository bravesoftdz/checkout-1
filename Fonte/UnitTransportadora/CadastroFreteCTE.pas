...
type
  TFormCadastroFreteCTE = class(TFormCadastroTEMPLATE)
...
var
  FormCadastroFreteCTE: TFormCadastroFreteCTE;
  lProcesso: TProcessInformation;

implementation

uses CadastroFreteItemCTE, CadastroCliente, 
...
procedure TFormCadastroFreteCTE.OpenTemp;
begin
...
procedure TFormCadastroFreteCTE.Button3Click(Sender: TObject);
begin
  inherited;
  DSMasterSys := DsTemplate;
  CriaFormulario(TFormCadastroFreteItemCTE,'FormCadastroFreteItemCTE',True,False,True,DSTemplate.DataSet.FieldByName('FRETA13ID').AsString);
end;

procedure TFormCadastroFreteCTE.FormCreate(Sender: TObject);
begin
  inherited;
  Tabela := 'FRETE';
  Insert := False;
...
procedure TFormCadastroFreteCTE.ButtonFinanceiroClick(Sender: TObject);
begin
  inherited;
  PagePrincipal.ActivePage := TabSheetFinanceiro;
end;

procedure TFormCadastroFreteCTE.ButtonCadastroRemetenteClick(Sender: TObject);
begin
  inherited;
...
procedure TFormCadastroFreteCTE.ButtonCadastroDestinatarioClick(
  Sender: TObject);
begin
  inherited;
...
procedure TFormCadastroFreteCTE.ButtonCadastroConsignatarioClick(
  Sender: TObject);
begin
  inherited;
...
procedure TFormCadastroFreteCTE.SQLTemplateBeforePost(DataSet: TDataSet);
...
procedure TFormCadastroFreteCTE.FormActivate(Sender: TObject);
begin
  inherited;
...
procedure TFormCadastroFreteCTE.SQLTemplateAfterInsert(DataSet: TDataSet);
begin
  inherited;
  Insert := True;
end;

procedure TFormCadastroFreteCTE.SQLTemplateAfterPost(DataSet: TDataSet);
begin
  inherited;
  if Insert then
    begin
...
procedure TFormCadastroFreteCTE.SQLTemplateNewRecord(DataSet: TDataSet);
begin
  inherited;
...
procedure TFormCadastroFreteCTE.SQLTemplateBeforeEdit(DataSet: TDataSet);
begin
  inherited;
...
procedure TFormCadastroFreteCTE.ButtonCadastroPlanoPagtoClick(
  Sender: TObject);
begin
  inherited;
...
procedure TFormCadastroFreteCTE.DBEdit9KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  if Key = VK_F2 then
...
procedure TFormCadastroFreteCTE.DBEdit10KeyDown(Sender: TObject;
...
procedure TFormCadastroFreteCTE.DBEdit11KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  inherited;
  if Key = VK_F2 then
...
procedure TFormCadastroFreteCTE.DBEdit3KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  if Key = VK_F3 then
...
procedure TFormCadastroFreteCTE.SQLTemplatePLRCICODChange(Sender: TField);
var
...
procedure TFormCadastroFreteCTE.SQLTemplateBeforeDelete(DataSet: TDataSet);
begin
  inherited;
...
procedure TFormCadastroFreteCTE.ComboNumerarioPrazoChange(Sender: TObject);
begin
  inherited;
  if ComboNumerarioPrazo.Value <> '' then
    begin
...
procedure TFormCadastroFreteCTE.ComboNumerarioVistaChange(Sender: TObject);
begin
  inherited;
  if ComboNumerarioVista.Value <> '' then
    begin
...
procedure TFormCadastroFreteCTE.SQLContasReceberBeforePost(DataSet: TDataSet);
begin
  inherited;
...
procedure TFormCadastroFreteCTE.ButtonCadastroFuncionarioClick(
  Sender: TObject);
begin
  inherited;
...
procedure TFormCadastroFreteCTE.MnConhecimentodeFreteClick(Sender: TObject);
var
  Produto : String;
begin
  inherited;
...
procedure TFormCadastroFreteCTE.ButtonCadastroVeiculoClick(Sender: TObject);
begin
  inherited;
...
procedure TFormCadastroFreteCTE.SQLContasReceberNewRecord(DataSet: TDataSet);
begin
  inherited;
...
procedure TFormCadastroFreteCTE.ReportWindowClose(Sender: TObject);
begin
  inherited;
  TblFrete.Close;
end;

procedure TFormCadastroFreteCTE.mnRomaneiodeFreteClick(Sender: TObject);
begin
  inherited;
  SQLQtdeItens.Close;
  SQLQtdeItens.MacroByName('MFiltro').AsString := ' FRETA13ID = '''+SQLTemplateFRETA13ID.AsString+'''';
...
procedure TFormCadastroFreteCTE.DBEdit19KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  inherited;
  if Key = VK_F2 then
...
procedure TFormCadastroFreteCTE.DBEdit22KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  inherited;
  if Key = VK_F2 then
...
procedure TFormCadastroFreteCTE.DBComboBox1Change(Sender: TObject);
begin
  inherited;
...
procedure TFormCadastroFreteCTE.SQLTemplateFRETA1TEMREMETENTEChange(
  Sender: TField);
begin
  inherited;
...
procedure TFormCadastroFreteCTE.SQLTemplateFRETA1TEMDESTINATARIOChange(
  Sender: TField);
begin
  inherited;
...
procedure TFormCadastroFreteCTE.SQLTemplateFRETA1TEMEXPEDIDORChange(
  Sender: TField);
begin
  inherited;
...
procedure TFormCadastroFreteCTE.SQLTemplateFRETA1TEMRECEBEDORChange(
  Sender: TField);
begin
  inherited;
...
procedure TFormCadastroFreteCTE.CheckBox1Click(Sender: TObject);
begin
  inherited;
  Panel4.Enabled := CheckBox1.Checked;
end;

procedure TFormCadastroFreteCTE.RxDBComboBox4Exit(Sender: TObject);
begin
  inherited;
...
procedure TFormCadastroFreteCTE.ConhecimentoEletronico1Click(Sender: TObject);
var comando : String;
var i: integer;
...
procedure TFormCadastroFreteCTE.DBEdit9Exit(Sender: TObject);
begin
  inherited;
...
procedure TFormCadastroFreteCTE.DBEdit10Exit(Sender: TObject);
begin
  inherited;
  If SQLTemplate.State in ([dsInsert,dsEdit]) then
  begin
...
procedure TFormCadastroFreteCTE.RxDBComboBox7Exit(Sender: TObject);
begin
  inherited;
...
procedure TFormCadastroFreteCTE.RxDBComboBox8Exit(Sender: TObject);
begin
  inherited;
...
procedure TFormCadastroFreteCTE.DBComboBox1Enter(Sender: TObject);
begin
  inherited;
...
procedure TFormCadastroFreteCTE.DBComboBox1Exit(Sender: TObject);
begin
  inherited;
...
procedure TFormCadastroFreteCTE.SpeedButton1Click(Sender: TObject);
begin
  inherited;
...
procedure TFormCadastroFreteCTE.AlterarNumerodoConhecimento1Click(
  Sender: TObject);
begin
  inherited;
  LabelAlterar.Click;
...
procedure TFormCadastroFreteCTE.CancelarConhecimentodeFrete1Click(
  Sender: TObject);
var i: integer;
  lStartUpInfo:TStartUpInfo;
  dir, direxec:string;
...
procedure TFormCadastroFreteCTE.GCTeXMLCancelamento;
...
procedure TFormCadastroFreteCTE.RxSpeedButton1Click(Sender: TObject);
begin
  inherited;
  DSMasterSys := DsTemplate;
