object FormTelaRecebimentoCrediario: TFormTelaRecebimentoCrediario
  ...
  object SQLRecebimento: TRxQuery
    ...
    UpdateObject = UpdateSQLRecebimento
    Macros = <>
    Left = 8
    Top = 63
  ...
  object UpdateSQLRecebimento: TUpdateSQL
    ModifySQL.Strings = (
      'update RECEBIMENTO'
      'set'
      '  CTRCA13ID = :CTRCA13ID,'
      '  RECEICOD = :RECEICOD,'
      '  RECEDRECTO = :RECEDRECTO,'
      '  RECEN2VLRRECTO = :RECEN2VLRRECTO,'
      '  RECEN2VLRJURO = :RECEN2VLRJURO,'
      '  RECEN2VLRMULTA = :RECEN2VLRMULTA,'
      '  RECEN2DESC = :RECEN2DESC,'
      '  EMPRICODREC = :EMPRICODREC,'
      '  TERMICODREC = :TERMICODREC,'
      '  CLIEA13ID = :CLIEA13ID,'
      '  PENDENTE = :PENDENTE,'
      '  REGISTRO = :REGISTRO,'
      '  RECEN2MULTACOBR = :RECEN2MULTACOBR'
      'where'
      '  CTRCA13ID = :OLD_CTRCA13ID and'
      '  RECEICOD = :OLD_RECEICOD')
    InsertSQL.Strings = (
      'insert into RECEBIMENTO'
      
        '  (CTRCA13ID, RECEICOD, RECEDRECTO, RECEN2VLRRECTO, RECEN2VLRJUR' +
        'O, RECEN2VLRMULTA, '
      
        '   RECEN2DESC, EMPRICODREC, TERMICODREC, CLIEA13ID, PENDENTE, RE' +
        'GISTRO, '
      '   RECEN2MULTACOBR)'
      'values'
      
        '  (:CTRCA13ID, :RECEICOD, :RECEDRECTO, :RECEN2VLRRECTO, :RECEN2V' +
        'LRJURO, '
      
        '   :RECEN2VLRMULTA, :RECEN2DESC, :EMPRICODREC, :TERMICODREC, :CL' +
        'IEA13ID, '
      '   :PENDENTE, :REGISTRO, :RECEN2MULTACOBR)')
    DeleteSQL.Strings = (
