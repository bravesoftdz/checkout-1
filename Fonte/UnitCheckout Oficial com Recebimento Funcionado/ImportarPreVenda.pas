...
uses
  ...
  DBCtrls, DBCGrids, MemTable, RXCtrls, EWall, Mask;
...
type
  TFormTelaImportarPreVenda = class(TForm)
    ...
    SQLReimpPreVendaPRVDN2TOTITENS: TBCDField;
    ...
    SQLReimpPreVendaPRVDN2ACRESC: TBCDField;
    SQLReimpPreVendaPRVDN2DESC: TBCDField;
    Label1: TLabel;
    DBGridLista: TDBGrid;
    Label2: TLabel;
    Label3: TLabel;
    ...
    TblMemPreVendaPRVDN2TOTITENS: TBCDField;
    ...
    SQLImportarPrevendaSelPRVDN2TOTITENS: TBCDField;
...
begin
  ...
  if vImportarPrevenda then
    begin
      ...
      DM.SQLPreVenda.MacroByName('Ordem').Value   := 'Order by '+ dm.sqlconfigvendaCFVEA20ORDIMPVEND.AsString ;
      DM.SQLPreVenda.Open ;
      ...
      begin
        ...
        if DM.SQLPreVendaCLIETOBS.Value <> '' then
          TblMemPreVendaCLIETOBS.Value     := DM.SQLPreVendaCLIETOBS.Value;
...
begin
  if Key = VK_Escape then
    begin
      ...
      VendedorVenda     := 0;
      FormTelaItens.LbVendedor.Caption := '';
      FormTelaItens.LbVendedor.Update ;
      Close ;
    end;
end;
        ...
        begin
          if (ExistePreVendaSelecionada) or (Dm.SQLConfigVendaCFVECIMPPREVDCOD.AsString = 'S') then
            begin
                ...
                Begin
                  If SQLImportarPrevendaSelPRVDCMARCADO.Value Then
                    Begin
                     ...
                     { while not DM.SQLPreVendaNumerario.EOF do
                        begin
                          DM.SQLPreVendaNumerario.Next ;
                        end ; }
              ...
              if VendedorVenda > 0 then
                begin
                  FormTelaItens.LbVendedor.Caption := SQLImportarPrevendaSelVendedor.Value;
                  FormTelaItens.LbVendedor.Update ;
                end;
