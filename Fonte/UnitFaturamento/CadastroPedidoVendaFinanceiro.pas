...
type
  TFormCadastroPedidoVendaFinanceiro = class(TFormCadastroTEMPLATE)
    ...
    TblPedidoVendaPDVDN2VLRDESC: TFloatField;
    TblPedidoVendaPDVDN2TOTPROD: TFloatField;
    TblPedidoVendaPDVDN2TOTPED: TFloatField;
    TblPedidoVendaPDVDN2VLRDESCPROM: TFloatField;
