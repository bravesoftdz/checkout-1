unit TelaConfigControleConfigImpressaoNF;
...
type
  TFormTelaConfigControleConfigImpressaoNF = class(TForm)
    Panel1: TPanel;
    Panel2: TPanel;
    Label1: TLabel;
    Label2: TLabel;
...
var
  FormTelaConfigControleConfigImpressaoNF: TFormTelaConfigControleConfigImpressaoNF;
