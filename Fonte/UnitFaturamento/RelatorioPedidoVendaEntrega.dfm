inherited FormRelatorioPedidoVendaEntrega: TFormRelatorioPedidoVendaEntrega
  Left = 186
  Top = 18
  Caption = 'Relat'#243'rio de Pedidos Vendas para o Entregador'
  ClientHeight = 543
  ClientWidth = 802
  PixelsPerInch = 96
  TextHeight = 13
  ...
  object SQLPedidoVenda: TRxQuery
    ...
    object SQLPedidoVendaCLIEA60NOMEFANT: TStringField
      FieldName = 'CLIEA60NOMEFANT'
      Origin = 'DB.CLIENTE.CLIEA60NOMEFANT'
      FixedChar = True
      Size = 60
    ...
    object SQLPedidoVendaCLIEA60ENDRES: TStringField
      FieldName = 'CLIEA60ENDRES'
      FixedChar = True
      Size = 60
    end
    object SQLPedidoVendaCLIEA60CIDRES: TStringField
      FieldName = 'CLIEA60CIDRES'
      FixedChar = True
      Size = 60
    end
    object SQLPedidoVendaCLIEA60BAIRES: TStringField
      FieldName = 'CLIEA60BAIRES'
      FixedChar = True
      Size = 60
    end
