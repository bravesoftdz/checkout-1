...
begin
  ...
  CriaFormulario(TFormTelaConsultaNumerario,'FormTelaConsultaNumerario',False,True,'');
end;
...
begin
  ...
  CriaFormulario(TFormTelaConsultaPortador,'FormTelaConsultaPortador',False,True,'');
end;
...
begin
  ...
  CriaFormulario(TFormTelaConsultaTipoDocumento,'FormTelaConsultaTipoDocumento',False,True,'');
end;
