...
type
  TFormCadastroNotaFiscalFinanceiro = class(TFormCadastroTEMPLATE)
    ...
    TblNotaFiscalNOFIN2VLRDESC: TBCDField;
    TblNotaFiscalNOFIN2VLRPRODUTO: TBCDField;
    TblNotaFiscalNOFIN2VLRNOTA: TBCDField;
    TblNotaFiscalNOFIN2VLRDESCPROM: TBCDField;
