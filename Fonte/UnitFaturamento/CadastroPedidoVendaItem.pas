...
type
  TFormCadastroPedidoVendaItem = class(TFormCadastroTEMPLATE)
    ...
    SQLTemplatePVITN3QUANT: TFloatField;
    SQLTemplatePVITN2VLRUNIT: TFloatField;
    SQLTemplatePVITN2PERCDESC: TFloatField;
    SQLTemplatePVITN2VLRDESC: TFloatField;
    ...
    SQLTemplatePVITN3QUANTVEND: TFloatField;
    Label1: TLabel;
    Label2: TLabel;
    Label3: TLabel;
    Label4: TLabel;
    ...
    DBEdit13: TDBEdit;
    Label17: TLabel;
    SQLTemplatePVITN2PERCCOMIS: TFloatField;
    Label18: TLabel;
    DBEdit14: TDBEdit;
...
//Verifica se o usuario pode alterar o vlr do item
  if not UsuarioMaster then
    if not Autenticado then
      begin
        if (DM.SQLConfigVendaCFVECSOLSENHAALTVLR.AsString = 'S') and not PermiteAlterarValorVenda then
