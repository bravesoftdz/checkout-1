inherited FormRelatorioNotaEmitidaPorICMS: TFormRelatorioNotaEmitidaPorICMS
  ...
  object SQLEstoque: TRxQuery
    ...
    object SQLEstoqueNFITN2BASEICMS: TBCDField
      FieldName = 'NFITN2BASEICMS'
      Precision = 15
      Size = 3
    end
    object SQLEstoqueNFITN2VLRICMS: TBCDField
      FieldName = 'NFITN2VLRICMS'
      Precision = 15
      Size = 2
    end
    object SQLEstoqueNFITN2BASESUBS: TBCDField
      FieldName = 'NFITN2BASESUBS'
      Precision = 15
      Size = 3
    end
    object SQLEstoqueNFITN2VLRSUBS: TBCDField
    ...
    object SQLEstoqueNOFIN2VLRNOTA: TBCDField
