...
type
  TFormRelatorioNotaEmitidaPorICMS = class(TFormRelatorioTEMPLATE)
    ...
    SQLEstoqueNFITN2BASEICMS: TBCDField;
    SQLEstoqueNFITN2VLRICMS: TBCDField;
    SQLEstoqueICMSICOD: TIntegerField;
    SQLEstoqueCLIEA60RAZAOSOC: TStringField;
    SQLEstoqueNFITN2BASESUBS: TBCDField;
    SQLEstoqueNFITN2VLRSUBS: TBCDField;
    SQLEstoqueNOFIN2VLRNOTA: TBCDField;
