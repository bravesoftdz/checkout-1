...
uses RXCtrls, RxQuery, Forms, DBTables, SysUtils, Dialogs ;
  ...
  function  FecharCupomFiscal_Bematech_MP20_FI(TipoAcrescDesc : String; Valor, VlrAcrescDesc, VlrTroco : Double ; Ecf_CNFV, Msg : String; SQLFPVista, SQLFPPrazo : TRxQuery;NomeCli,EnderecoCli,CidadeCli, DocumentoCli, IDCupom, Vendedor, Plano:string) : boolean ;
