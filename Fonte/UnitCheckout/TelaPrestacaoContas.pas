...
type
  TFormTelaPrestacaoContas = class(TForm)
    ...
    SQLEncerranteDiarioENDIN2ENCERINI: TFloatField;
    SQLEncerranteDiarioENDIN2ENCERFIM: TFloatField;
    SQLEncerranteDiarioENDIN2AFERICAO: TFloatField;
    ...
    SQLPrestaContasVLRMOEDA: TFloatField;
    SQLPrestaContasVLRCHPRAZO: TFloatField;
    SQLPrestaContasVLRNTPRAZO: TFloatField;
    SQLPrestaContasVLRNTAVULSO: TFloatField;
    SQLPrestaContasVLRCARCREDITO: TFloatField;
    SQLPrestaContasVLRVALES: TFloatField;
    SQLPrestaContasVLRORFRE: TFloatField;
    SQLPrestaContasVLROUTSAIDA: TFloatField;
    ...
    Label9: TLabel;
    Label10: TLabel;
    SQLPrestaContasVLRCHVISTA: TFloatField;
    ...
    SQLUltimoEncerENDIN2ENCERINI: TFloatField;
    SQLUltimoEncerENDIN2ENCERFIM: TFloatField;
    SQLUltimoEncerENDIN2AFERICAO: TFloatField;
