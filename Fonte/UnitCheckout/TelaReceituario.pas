...
uses
  ...
  RXDBCtrl, ppStrtch, ppMemo, BDE, UCrpe32, ppParameter, ppModule, raCodMod;
...
{  Declaracao.Lines.Clear ;
  ...
  if SQLClienteReceituarioCLRCCTIPOOS.Value = 'J' then
    begin
      if DM.SQLTerminalAtivoTERMA30MODIMPNFISC.Value = 'BEMATECH MP-20 CI' then
  ...
  if SQLClienteReceituarioCLRCCTIPOOS.Value = 'R' then
    begin
      if DM.SQLTerminalAtivoTERMA30MODIMPNFISC.Value = 'BEMATECH MP20 CI' then
