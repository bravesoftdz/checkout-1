...
begin
     ...
     begin
       if DM.SQLNumerarioNUMECATIVO.AsString = 'S' then
         begin
           ...
           DM.SQLFechamentoCaixaFECXDDATAMOV.AsDateTime := Dm.SQLTerminalAtivoTERMDSTATUSCAIXA.AsDateTime;
   ...
   DM.SQLFechamentoCaixa.SQL.Add('SELECT * FROM FECHAMENTOCAIXA WHERE FECXDDATAMOV  = ' + '"' + FormatDateTime('mm/dd/yyyy',Dm.SQLTerminalAtivoTERMDSTATUSCAIXA.AsDateTime)+ '"');
