object FormPrincipalRelatorios: TFormPrincipalRelatorios
  ...
  object SQLItensVendidos: TRxQuery
    ...
    SQL.Strings = (
      ...
      '  sum(CUPOMITEM.CPITN3QTD-CUPOMITEM.CPITN3QTDTROCA) as QTDE,'
        ...
        'EM.CPITN3VLRUNIT * CUPOMITEM.cpitn3qtdtroca)  - CUPOMITEM.CPITN2' +
        'DESC) as VLRTOTALITEM'
      'from'
                                    ...
                                    object SubVendasCartoesCheque: TppSubReport
                                      ...
                                      object ppChildReport6: TppChildReport
                                        ...
                                        object SumarioVendaCartoes: TppSummaryBand
                                          BeforePrint = SumarioVendaCartoesBeforePrint
                                          PrintHeight = phDynamic
                                          mmBottomOffset = 0
                                          mmHeight = 9790
                                          mmPrintPosition = 0
                                          ...
                                          object ppSubReport2: TppSubReport
                                            ...
                                            object ppChildReport2: TppChildReport
                                              AutoStop = False
                                              DataPipeline = PipeCrediarioDetalhado
                                              PrinterSetup.BinName = 'Default'
                                              PrinterSetup.DocumentName = 'Report'
                                              PrinterSetup.PaperName = 'A4'
                                              PrinterSetup.PrinterName = 'Default'
                                              ...
                                              mmColumnWidth = 0
                                              DataPipelineName = 'PipeCrediarioDetalhado'
                                              object TituloCrediarioDetalhado: TppTitleBand
                                                mmBottomOffset = 0
                                                mmHeight = 16140
                                                mmPrintPosition = 0
                                                object ppLabel4: TppLabel
                                                  ...
                                                  Border.Style = psSolid
                                                  Border.Visible = False
                                                  Caption = 'Demonstrativo do Credi'#225'rio'
                                                  Font.Charset = DEFAULT_CHARSET
                                                  Font.Color = clBlack
                                                  Font.Name = 'Tahoma'
                                                  Font.Size = 10
                                              ...
                                              object DetalheCrediarioDetalhado: TppDetailBand
                                                mmBottomOffset = 0
                                                mmHeight = 5027
                                                mmPrintPosition = 0
                                              ...
                                              object SumarioCrediarioDetalhado: TppSummaryBand
                                                mmBottomOffset = 0
                                                mmHeight = 3175
                                                mmPrintPosition = 0
                                              end
                                              object ppGroup2: TppGroup
                                                BreakName = 'NUMEA30DESCR'
                                                DataPipeline = PipeCrediarioDetalhado
                                                KeepTogether = True
                                                OutlineSettings.CreateNode = True
                                                UserName = 'Group2'
                                                ...
                                                object TotalCrediarioDetalhado: TppGroupFooterBand
                                                  mmBottomOffset = 0
                                                  mmHeight = 4233
                                                  mmPrintPosition = 0
  ...
  object SQLCrediarioDetalhado: TRxQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      
        'select M.MVCXN2VLRDEB, M.MVCXN2VLRCRED, N.NUMEA30DESCR, '#39'CREDIAR' +
        'IO'#39' TIPO'
      'from MOVIMENTOCAIXA M'
      'left join NUMERARIO N on N.NUMEICOD = M.NUMEICOD'
      'where M.OPCXICOD = (select OPCXICOD'
      '                    from OPERACAOCAIXA'
      '                    where OPCXA5SIGLA in ("RCCRD")) and'
      '      (%MDATA) and'
      '      (%MEMPRESA) and'
      '      (%MTERMINAL) and'
      '      (%MOPERADOR)'
      'union all'
        ...
        'select M.MVCXN2VLRDEB, M.MVCXN2VLRCRED, N.NUMEA30DESCR, '#39'JUROS'#39' ' +
        'TIPO'
      'from MOVIMENTOCAIXA M'
      'left join NUMERARIO N on N.NUMEICOD = M.NUMEICOD'
      'where M.OPCXICOD = (select OPCXICOD'
      '                    from OPERACAOCAIXA'
      '                    where OPCXA5SIGLA in ("JURRC")) and'
      '      (%MDATA) and'
      '      (%MEMPRESA) and'
      '      (%MTERMINAL) and'
      '      (%MOPERADOR)')
    ...
    Left = 466
    Top = 33
    object SQLCrediarioDetalhadoMVCXN2VLRDEB: TFloatField
      FieldName = 'MVCXN2VLRDEB'
    end
    object SQLCrediarioDetalhadoMVCXN2VLRCRED: TFloatField
      FieldName = 'MVCXN2VLRCRED'
    end
    object SQLCrediarioDetalhadoNUMEA30DESCR: TStringField
      FieldName = 'NUMEA30DESCR'
      FixedChar = True
      Size = 30
    end
    object SQLCrediarioDetalhadoTIPO: TStringField
      FieldName = 'TIPO'
      FixedChar = True
      Size = 9
    end
  end
  object DSSQLCrediarioDetalhado: TDataSource
    DataSet = SQLCrediarioDetalhado
    Left = 494
    Top = 33
  end
  object PipeCrediarioDetalhado: TppBDEPipeline
    DataSource = DSSQLCrediarioDetalhado
    UserName = 'PipeCrediarioDetalhado'
    Left = 356
    Top = 315
    object PipeCrediarioDetalhadoppField1: TppField
      Alignment = taRightJustify
    ...
    object PipeCrediarioDetalhadoppField2: TppField
      Alignment = taRightJustify
    ...
    object PipeCrediarioDetalhadoppField3: TppField
      FieldAlias = 'NUMEA30DESCR'
      FieldName = 'NUMEA30DESCR'
      FieldLength = 30
      DisplayWidth = 30
  ...
  object SQLTrocas: TRxQuery
    ...
    SQL.Strings = (
        ...
        'select sum(C.CUPON3BONUSTROCA) VALOR_TROCA, count(C.CUPOA13ID) Q' +
        'TDE_TROCA'
      'from CUPOM C'
      'where C.CUPOCSTATUS <> '#39'C'#39' and'
      '      C.CUPON3BONUSTROCA > 0 and'
      '      %MTERMINAL and'
      '      %MDATA and'
      '      %MOPERADOR and'
      '      %MEMPRESA')
    ...
    Left = 34
    Top = 321
    object SQLTrocasVALOR_TROCA: TFloatField
      FieldName = 'VALOR_TROCA'
      Origin = 'DB.CUPOM.CUPON3BONUSTROCA'
    end
    object SQLTrocasQTDE_TROCA: TIntegerField
  ...
  object PipeTrocas: TppBDEPipeline
    DataSource = DSSQLTrocas
    UserName = 'PipeTrocas'
    Left = 428
    Top = 315
    object PipeTrocasppField1: TppField
      Alignment = taRightJustify
      FieldAlias = 'VALOR_TROCA'
      FieldName = 'VALOR_TROCA'
      FieldLength = 0
      DataType = dtDouble
      DisplayWidth = 0
    ...
    object PipeTrocasppField2: TppField
      Alignment = taRightJustify
      FieldAlias = 'QTDE_TROCA'
      FieldName = 'QTDE_TROCA'
      FieldLength = 0
      DataType = dtInteger
      DisplayWidth = 10
