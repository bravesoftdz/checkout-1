inherited FormRelatorioComprasMarca: TFormRelatorioComprasMarca
  Left = 206
  Top = 132
  Caption = 'Relat'#243'rio de Compras Por Marca'
  PixelsPerInch = 96
  TextHeight = 13
  inherited TblTemporaria: TTable
    TableName = 'RelVendasMarca.DB'
  ...
  object SQLCompraMarca: TRxQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      'select'
      '  PRODUTO.MARCICOD,'
    ...
    Left = 424
    Top = 5
    object SQLCompraMarcaMARCICOD: TIntegerField
      FieldName = 'MARCICOD'
    end
    object SQLCompraMarcaMARCA60DESCR: TStringField
      FieldName = 'MARCA60DESCR'
      FixedChar = True
      Size = 60
    end
    object SQLCompraMarcaQTDETOTAL: TFloatField
      FieldName = 'QTDETOTAL'
    end
    object SQLCompraMarcaTOTAL: TFloatField
      FieldName = 'TOTAL'
    end
  end
  object Report: TCrpe
