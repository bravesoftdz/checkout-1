...
type
  TFormRelatorioDivergenciaInventario = class(TFormRelatorioTEMPLATE)
    ...
    TblTemporariaCONTAGEM: TBCDField;
    SQLProduto: TRxQuery;
    ...
    TblTempProdutoPRODN3VLRVENDA: TBCDField;
    TblTempProdutoPRODN3VLRCOMPRA: TBCDField;
    TblTempProdutoPRODN3VLRCUSTO: TBCDField;
    TblTempProdutoPSLDN3QTDE: TBCDField;
    TblTempProdutoCONTAGEM: TBCDField;
    ...
    TblTemporaria2PRODN3VLRVENDA: TBCDField;
    TblTemporaria2PRODN3VLRCOMPRA: TBCDField;
    TblTemporaria2PRODN3VLRCUSTO: TBCDField;
    TblTemporaria2CONTAGEM: TBCDField;
    TblTemporaria2GRTMA5DESCR: TStringField;
    TblTemporaria2CORA30DESCR: TStringField;
    TblTemporaria2PSLDN3QTDE: TBCDField;
