inherited FormRelatorioProdutosComprados: TFormRelatorioProdutosComprados
  Left = 170
  Top = 102
  ...
  inherited ScrollBox: TScrollBox
    ...
    inherited PanelCentro: TPanel
      ...
      object RadioPisCofins: TRadioGroup
        Left = 12
        Top = 331
        Width = 304
        Height = 40
  ...
  inherited TblTemporaria: TTable
    ...
    object TblTemporariaEMPRICODDESTCOMPRA: TIntegerField
  ...
  object SQLCompras: TRxQuery
    ...
    SQL.Strings = (
      ...
      '  NOTACOMPRA.NOCPDRECEBIMENTO AS CUPODEMIS,'
      '  NOTACOMPRA.REGISTRO,'
      '  NOTACOMPRAITEM.PRODICOD,'
      
        '  (NOTACOMPRAITEM.NOCIN3VLREMBAL/NOTACOMPRAITEM.NOCIN3CAPEMBAL) ' +
        'AS VALORUNIT,'
      '  NOTACOMPRAITEM.NOCIN3VLREMBAL,'
      '  NOTACOMPRAITEM.NOCIN3CAPEMBAL,'
      '  PRODUTO.PRODA60DESCR,'
      
        '  (NOTACOMPRAITEM.NOCIN3VLREMBAL * NOTACOMPRAITEM.NOCIN3QTDEMBAL' +
        ') + NOTACOMPRAITEM.NOCIN3VLRSUBST + NOTACOMPRAITEM.NOCIN3VLRIPI ' +
        '+ NOTACOMPRAITEM.NOCIN2VLRDESPESAS - NOTACOMPRAITEM.NOCIN3VLRDES' +
        'C AS VLRTOTALITEM,'
      ...
      '  NOTACOMPRAITEM.NOCIN3QTDEMBAL AS CPITN3QTD,'
      '  NOTACOMPRA.NOCPA13ID AS CUPOA13ID,'
      '  NOTACOMPRA.FORNICOD,'
      '  NOTACOMPRAITEM.CFOPA5CODAUX'
      'from'
      
        '  ((NOTACOMPRAITEM inner join NOTACOMPRA  on NOTACOMPRAITEM.NOCP' +
        'A13ID = NOTACOMPRA.NOCPA13ID)'
    ...
    object SQLComprasCUPODEMIS: TDateTimeField
      FieldName = 'CUPODEMIS'
    end
