...
uses TelaAgendaContatos, UnitLibrary, DataModulo;
...
begin
  inherited;
  SQLContatoUSUAICOD.asInteger := dm.SQLUsuarioUSUAICOD.Value;
...
begin
  ...
  If (SQLContatoTPCTICODPROX.AsVariant<>Null) and (SQLContatoCONTDPROXCONT.AsVariant<>Null) Then
    Begin
      ...
      DM.SQLNovoContatoEMPRICOD.Value          := SQLContatoEMPRICOD.Value;
      DM.SQLNovoContatoCONTDCONTATO.asDateTime := SQLContatoCONTDPROXCONT.asDateTime;
      DM.SQLNovoContatoCONTICOD.Value          := DM.ProximoCodigoUnico('CONTATO',SQLContato,dsContato,2);
      ...
      DM.SQLNovoContatoUSUAICOD.AsInteger      := dm.SQLUsuarioUSUAICOD.Value;
      DM.SQLNovoContatoREGISTRO.Value          := Now;
      DM.SQLNovoContatoPENDENTE.Value          := 'S';
