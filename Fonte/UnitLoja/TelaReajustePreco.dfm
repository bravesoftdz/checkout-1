inherited FormTelaReajustePreco: TFormTelaReajustePreco
        ...
        object TabReajuste: TTabSheet
          ...
          object GroupBox2: TGroupBox
            ...
            Hint = 
              'Voc'#234' s'#243' pode usar este filtro se n'#227'o tiver nenhum produto seleci' +
              'onado no filtro "Produto" !'
            Caption = ' Cd.Principal para ajuste de pre'#231'os '
            Font.Charset = ANSI_CHARSET
            Font.Color = clWindowText
            Font.Height = -11
            Font.Name = 'Tahoma'
            ...
            ShowHint = False
            TabOrder = 6
            object EditCdPrincipalAjustePrecos: TEdit
              Left = 8
              Top = 16
              Width = 101
              Height = 21
              TabOrder = 0
              OnExit = EditCdPrincipalAjustePrecosExit
            end
            object EditDescr2: TEdit
              Left = 113
              Top = 16
              Width = 300
              Height = 21
  ...
  object SQLProdutoGrade: TRxQuery
    ...
    object SQLProdutoGradePRODN3VLRCUSTOMED: TBCDField
      FieldName = 'PRODN3VLRCUSTOMED'
      Origin = 'DB.PRODUTO.PRODN3VLRCUSTOMED'
      Precision = 15
      Size = 3
    end
    object SQLProdutoGradePRODN3PERCMARGLUCR: TBCDField
      FieldName = 'PRODN3PERCMARGLUCR'
      Origin = 'DB.PRODUTO.PRODN3PERCMARGLUCR'
      Precision = 15
      Size = 3
  ...
  object SQLProdutoTabelaPreco: TRxQuery
    ...
    object SQLProdutoTabelaPrecoTPCPN3VLRVENDA: TBCDField
      FieldName = 'TPCPN3VLRVENDA'
      Origin = 'DB.TABELAPRECOPRODUTO.TPCPN3VLRVENDA'
      Precision = 15
      Size = 3
    end
    object SQLProdutoTabelaPrecoTPCPN3MARGLUCR: TBCDField
    ...
    object SQLProdutoTabelaPrecoTPCPN3VLRVENDAPROM: TBCDField
