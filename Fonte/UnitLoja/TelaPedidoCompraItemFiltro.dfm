inherited FormTelaPedidoCompraItemFiltro: TFormTelaPedidoCompraItemFiltro
  ...
  object zProdSaldo: TZQuery
    Connection = DM.zdb
    CachedUpdates = False
    SQL.Strings = (
      'Select EMPRICOD, PSLDN3QTDE, PSLDN3QTDMIN from PRODUTOSALDO')
    ParamCheck = True
    Params = <>
    ShowRecordTypes = [usUnmodified, usModified, usInserted]
    UpdateMode = umUpdateChanged
    ...
    Left = 836
    Top = 289
    object zProdSaldoEMPRICOD: TIntegerField
      DisplayLabel = 'Filial'
      FieldName = 'EMPRICOD'
    end
    object zProdSaldoPSLDN3QTDE: TFloatField
      DisplayLabel = 'Saldo'
      FieldName = 'PSLDN3QTDE'
      DisplayFormat = '##0.000'
    end
    object zProdSaldoPSLDN3QTDMIN: TFloatField
      FieldName = 'PSLDN3QTDMIN'
      DisplayFormat = '##0.000'
    end
  end
