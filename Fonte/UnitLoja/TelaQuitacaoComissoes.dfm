inherited FormTelaQuitacaoComissoes: TFormTelaQuitacaoComissoes
  ...
  object SQLComissao: TRxQuery
    ...
    object SQLComissaoVDCON3VLRQUITADO: TBCDField
  ...
  object SQLTotais: TRxQuery
    ...
    object SQLTotaisTOTALVISTA: TBCDField
      FieldName = 'TOTALVISTA'
      Origin = 'DB.VENDEDORCOMISSAO.VDCON2TOTVENDVISTA'
      Precision = 15
      Size = 3
    end
    object SQLTotaisTOTALPRAZO: TBCDField
      FieldName = 'TOTALPRAZO'
      Origin = 'DB.VENDEDORCOMISSAO.VDCON2TOTVENDPRAZO'
      Precision = 15
      Size = 3
    end
    object SQLTotaisTOTALCOMISSAO: TBCDField
      FieldName = 'TOTALCOMISSAO'
      Origin = 'DB.VENDEDORCOMISSAO.VDCON2VLRCOMISS'
      Precision = 15
      Size = 3
    end
    object SQLTotaisTOTALPARCIAL: TBCDField
  ...
  object CdsTotais: TClientDataSet
    ...
    object CdsTotaisTOTALVISTA: TBCDField
    ...
    object CdsTotaisTOTALPRAZO: TBCDField
    ...
    object CdsTotaisTOTALCOMISSAO: TBCDField
    ...
    object CdsTotaisTOTALPARCIAL: TBCDField
      FieldName = 'TOTALPARCIAL'
      Precision = 15
      Size = 3
    end
