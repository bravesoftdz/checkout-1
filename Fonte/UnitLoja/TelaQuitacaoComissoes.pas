...
type
  TFormTelaQuitacaoComissoes = class(TFormTelaGeralTEMPLATE)
    ...
    SQLComissaoVDCON2TOTVENDVISTA: TBCDField;
    SQLComissaoVDCON2TOTVENDPRAZO: TBCDField;
    SQLComissaoVDCOINROVEND: TIntegerField;
    SQLComissaoVDCON2VENDMEDIA: TBCDField;
    SQLComissaoVDCON3QTDVEND: TBCDField;
    SQLComissaoVDCON2VLRCOMISS: TBCDField;
    ...
    SQLTotaisTOTALVISTA: TBCDField;
    SQLTotaisTOTALPRAZO: TBCDField;
    SQLTotaisTOTALCOMISSAO: TBCDField;
    ...
    CdsTotaisTOTALVISTA: TBCDField;
    CdsTotaisTOTALPRAZO: TBCDField;
    CdsTotaisTOTALCOMISSAO: TBCDField;
    ...
    SQLComissaoVDCON3VLRQUITADO: TBCDField;
    CdsTotaisValoTotal: TFloatField;
    Label2: TLabel;
    SQLTotaisTOTALPARCIAL: TBCDField;
    CdsTotaisTOTALPARCIAL: TBCDField;
