inherited FormRelatorioRegVendaAgrotoxico: TFormRelatorioRegVendaAgrotoxico
  Caption = 'Registro de Venda de Agrot'#243'xicos Fitosanit'#225'rios'
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited TblTemporaria: TTable
    TableName = 'RelRegVendaAgrotoxico.DB'
    ...
    object TblTemporariaNFITN3QUANT: TBCDField
    ...
    object TblTemporariaNATUREZAOPERCAO: TStringField
      FieldName = 'NATUREZAOPERCAO'
      Size = 60
    end
    object TblTemporariaRECEITA: TStringField
      FieldName = 'RECEITA'
      Size = 15
    end
    object TblTemporariaPRINCIPIOATIVO: TStringField
      FieldName = 'PRINCIPIOATIVO'
      Size = 30
    end
    object TblTemporariaESTOQUE: TFloatField
      FieldName = 'ESTOQUE'
    end
  ...
  object SQLVendas: TRxQuery
    ...
    SQL.Strings = (
      ...
      'order by'
      '  NOTAFISCALITEM.PRODICOD,   NOTAFISCAL.NOFIINUMERO asc'
      ''
      '')
    Macros = <
      item
    ...
    object SQLVendasNFITN3QUANT: TBCDField
      FieldName = 'NFITN3QUANT'
      Precision = 15
      Size = 3
    end
    ...
    object SQLVendasNOFIINUMERO: TIntegerField
      FieldName = 'NOFIINUMERO'
    end
    ...
    object SQLVendasOPESICOD: TIntegerField
      FieldName = 'OPESICOD'
    end
  end
end
