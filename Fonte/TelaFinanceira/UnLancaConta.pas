...
uses
  ...
  CurrEdit, RXDBCtrl, ToolEdit, StdCtrls, Mask, DBCtrls, DBEditKey,
  Buttons, RXCtrls, ExtCtrls, Grids, DBGrids, db, ComCtrls, RxGrdCpt,
  RxMemDS, IBSQL;
...
uses UnDataModule, UnLancaNoCaixa, UnUpperIni ;
...
begin
   try
      ...
      begin
         ...
         RxTableDESCR.asstring  := UpperIni(NewDescr);
...
begin
   ...
   begin
      ...
      begin
         ...
         RxTableDESCR.asstring  := UpperIni(Trim(edtDescricao.text)+' - à vista');
         RxTableEMI.asDateTime  := StrToDate(edtEmissao.Text);
         RxTable.Post;
