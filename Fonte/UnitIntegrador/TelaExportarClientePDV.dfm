inherited FormTelaExportarClientePDV: TFormTelaExportarClientePDV
  Left = 246
  Top = 104
  Caption = 'Exportar Clientes para PDV'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  inherited ScrollBoxFundo: TScrollBox
    ...
    inherited PanelCentral: TPanel
      ...
      object ExpProdAlter: TCheckBox
        ...
        Height = 17
        TabStop = False
        Caption = 'Exportar somente clientes alterados'
        Checked = True
        Font.Charset = ANSI_CHARSET
        Font.Color = 8404992
        Font.Height = -11
  ...
  object SQLClienteOrig: TRxQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      'select * from CLIENTE'
      'where %MFiltro')
  ...
  object SQLClienteDest: TRxQuery
    DatabaseName = 'DBImp'
    RequestLive = True
    SQL.Strings = (
      'select * from CLIENTE'
