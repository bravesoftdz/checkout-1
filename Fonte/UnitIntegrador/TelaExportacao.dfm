inherited FormTelaExportacao: TFormTelaExportacao
  Left = 529
  Top = 150
  Width = 771
  Height = 476
  Caption = 'Exporta'#231#227'o do LOG'
  OldCreateOrder = True
  ...
  object SQLCampoPendente: TRxQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      'SELECT PENDENTE FROM %MTabela where 0=1')
    Macros = <
      item
        DataType = ftString
        Name = 'MTabela'
  ...
  object TabelasReativar: TDatabaseItems
    DatabaseName = 'Easy_Temp'
    Left = 136
    Top = 96
    object TabelasReativarNAME: TStringField
      FieldName = 'NAME'
      Size = 260
    end
  end
  object TabelaHaReativar: TTable
    Left = 136
    Top = 124
  end
  object SQLReAtivar: TRxQuery
    DatabaseName = 'DB'
    Macros = <>
    Left = 136
    Top = 152
