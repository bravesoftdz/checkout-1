...
begin
  ...
  CriaFormulario(TFormCadastroClientePropect,'FormCadastroClientePropect',False,True,'');
end;
...
begin
  ...
  CriaFormulario(TFormCadastroHistorico,'FormCadastroHistorico',False,False,'Cliente '+ SQLTemplatePRCLA60RAZAOSOC.AsString);
end;
