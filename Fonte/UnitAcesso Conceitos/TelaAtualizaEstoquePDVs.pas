...
uses
  ...
  DBTables, RxQuery, Gauges, RxLookup;
...
begin
  ...
  SQLCupomItem.Sql.Add('From CUPOMITEM Where CUPOMITEM.EMPRICOD = '+EmpresaPadrao+' and CUPOMITEM.REGISTRO >= "'+FormatDateTime('mm/dd/yy 00:01:01', DtBaseImp.Date)+'" and CUPOMITEM.REGISTRO <= "'+FormatDateTime('mm/dd/yy 23:59:59', DtBaseImp.Date) +'" and (CUPOMITEM.CPITCSTATUS = "A")');
  ...
  while not SQLCupomItem.eof do
    begin
      ...
      {if SQLCupomItem.FindField('PRODICOD').AsString = '404' then
        showmessage('Coca => Qtde => '+SQLCupomItem.Fieldbyname('Qtde').AsString); }

      if not FileExists('NaoTestaMovimentoEstoque.txt') then
        begin
          DM.SQLTemplate.Close ;
            ...
            begin
              ...
              if SQLCupomItem.FindField('Qtde').Value > 0 then
                GravaMovimentoEstoque(DM.SQLProduto,
                                      ...
                                      DM.SQLConfigVendaOPESICODCUPOM.asInteger,//Operacao
    ...
    begin
      ...
      if SQLCupomItem.fieldbyname('QtdeSaida').Value > 0 then
        GravaMovimentoEstoque(DM.SQLProduto,
                              ...
                              StrToInt(EmpresaPadrao),//Empresa
                              SQLCupomItem.FindField('PRODICOD').asInteger,//Produto
                              DM.SQLConfigVendaOPESICODCANCCUPOM.asInteger,//Operacao
        ...
        GravaMovimentoEstoque(DM.SQLProduto,
                              ...
                              StrToInt(EmpresaPadrao),//Empresa
                              SQLCupomItem.FindField('PRODICOD').asInteger,//Produto
                              DM.SQLConfigVendaOPESICODCANCTROCA.Value,//Operacao
