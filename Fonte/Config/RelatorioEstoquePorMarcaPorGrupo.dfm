inherited FormRelatorioEstoquePorMarcaPorGrupo: TFormRelatorioEstoquePorMarcaPorGrupo
  Top = 99
  Caption = 'Relat'#243'rio de Estoque Por Marca por Grupo'
  ClientWidth = 787
  PixelsPerInch = 96
  TextHeight = 13
    ...
    inherited PanelCentro: TPanel
      ...
      object GroupBox3: TGroupBox
        ...
        object ComboGrupo: TRxDBLookupCombo
          ...
          LookupDisplay = 'GRUPICOD;GRUPA60DESCR'
      ...
      object GroupBox4: TGroupBox
        ...
        object ComboSubgrupo: TRxDBLookupCombo
          ...
          LookupDisplay = 'SUBGICOD;SUBGA60DESCR'
          LookupDisplayIndex = 1
  ...
  inherited TblTemporaria: TTable
    TableName = 'SaldoPorMarcaPorGrupo.db'
  ...
  object SQLSaldo: TRxQuery
    ...
    object SQLSaldoGRUPA60DESCR: TStringField
      FieldName = 'GRUPA60DESCR'
      FixedChar = True
      Size = 60
    end
  ...
  object SQLGeral: TQuery
    DatabaseName = 'DBTemp'
    SQL.Strings = (
      'DELETE FROM SaldoPorMarcaPorGrupo WHERE SALDO <= 0')
    Left = 619
    Top = 5
  end
end
