...
begin
  ...
  case RadioEtiqueta.ItemIndex of
     ...
     7 : begin
           ppTexto.LoadFromFile(DM.SQLConfigCrediarioCFCRA255PATHCARTPE.Value) ;
           ReportCartas.Print ;
         end;
  end;
end;
...
begin
  inherited;
  ppNomeFantasia.Caption := dm.SQLLocate('EMPRESA','EMPRICOD','EMPRA60NOMEFANT',DM.SQLTerminalAtivoEMPRICOD.AsString);
  ppEndereco.Caption     := dm.SQLLocate('EMPRESA','EMPRICOD','EMPRA60END',DM.SQLTerminalAtivoEMPRICOD.AsString);
  ppCidade.Caption       := dm.SQLLocate('EMPRESA','EMPRICOD','EMPRA60CID',DM.SQLTerminalAtivoEMPRICOD.AsString)+'/RS';
  ppBairro.Caption       := dm.SQLLocate('EMPRESA','EMPRICOD','EMPRA60BAI',DM.SQLTerminalAtivoEMPRICOD.AsString);
  ppCep.Caption          := dm.SQLLocate('EMPRESA','EMPRICOD','EMPRA8CEP',DM.SQLTerminalAtivoEMPRICOD.AsString);
end;
