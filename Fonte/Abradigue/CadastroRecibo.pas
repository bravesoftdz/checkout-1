...
type
  TFormCadastroRecibo = class(TFormCadastroTEMPLATE)
    ...
    SQLTemplateRECIN2VLRBRUTO: TBCDField;
    SQLTemplateRECIN2VLRIRRF: TBCDField;
    SQLTemplateRECIN2VLRLIQUIDO: TBCDField;
    ...
    MnCliente: TMenuItem;
    TblRecibo: TTable;
    TblReciboRECIN2VLRBRUTO: TBCDField;
    TblReciboRECIN2VLRIRRF: TBCDField;
...
begin
  inherited;
    ...
    TblReciboRECIDEMISSAO.AsString        := FormatDateTime('dd/mm/yyyy',Now);
    TblReciboRECIN2VLRBRUTO.AsFloat       := SQLTemplateRECIN2VLRBRUTO.AsFloat;
    TblReciboRECIN2VLRIRRF.AsFloat        := SQLTemplateRECIN2VLRIRRF.AsFloat;
    TblReciboRECIN2VLRLIQUIDO.AsFloat     := SQLTemplateRECIN2VLRLIQUIDO.AsFloat;
    ValorExtenso(VExt,SQLTemplateRECIN2VLRLIQUIDO.AsFloat, '', '', 02, 85, '*',3);
...
begin
  ...
  begin
    ...
    CriaFormulario(TFormCadastroFuncionario,'FormCadastroFuncionario',False,True,'');
  end;
