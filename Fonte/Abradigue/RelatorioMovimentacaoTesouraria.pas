...
type
  TFormRelatorioMovimentacaoTesouraria = class(TFormRelatorioTEMPLATE)
    ...
    SQLMovtoTesourariaTESON2VLRDEBITO: TBCDField;
    SQLMovtoTesourariaTESON2VLRCREDITO: TBCDField;
    ...
    SQLSaldosCREDITOS: TBCDField;
    SQLSaldosDEBITOS: TBCDField;
    ...
    SQLMovimentoCaixaTESON2VLRDEBITO: TBCDField;
    SQLMovimentoCaixaTESON2VLRCREDITO: TBCDField;
