...
uses
  ...
  CurrEdit, Placemnt, Variants, VarSys, ComCtrls;
...
uses DataModulo, UnitLibrary,
     TelaBaixarDocumentosPagarPagamento, CadastroRecibo,
...
begin
  ...
  if DM.SQLConfigFinanceiroCGFICINFPLCTBXSIMP.AsString = 'S' then
    begin
...
begin
    ...
    begin
      ...
      if VlrTotal > 0 then
        begin
          ...
          if ComboFornecedor.KeyValue <> null then
            FormTelaBaixaDocumentosPagarPagamento.MemoHistTesouraria.Text := 'Fornecedor: '+ ComboFornecedor.LookupDisplay;
  ...
  if ((Application.FindComponent('FormTelaBaixaDocumentosPagarPagamento') <> nil)
    ...
    or (DM.SQLConfigFinanceiroCGFIUSATESOURARIA.AsString <> 'S') then
    begin
      SQLPagamento.Open ;
      TblPagtosTemp.DisableControls;
      TblPagtosTemp.First ;
      ...
      begin
        ...
        begin
          ...
          SQLPagamentoPENDENTE.Value       := 'S' ;
          SQLPagamentoREGISTRO.Value       := Now ;
          if (DM.SQLConfigFinanceiroCGFIUSATESOURARIA.AsString = 'S') and
              ...
              case FormTelaBaixaDocumentosPagarPagamento.FormaPagamento[1] of
                'D' : begin
                        ...
                        LancaMovimentacaoTesouraria(StrToInt(EmpresaPadrao),TerminalAtual,
                                                    ...
                                                    TblPagtosTempCTPGA13ID.AsString,'','','',FormTelaBaixaDocumentosPagarPagamento.DataMovTesouraria.Date,TblPagtosTempDocumento.AsString,'');
                      end;
                'C' : begin
