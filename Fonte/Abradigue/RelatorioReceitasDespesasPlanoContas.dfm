inherited FormRelatorioReceitasDespesasPlanoContas: TFormRelatorioReceitasDespesasPlanoContas
  ...
  inherited ScrollBox: TScrollBox
    ...
    object Label8: TLabel [3]
      ...
      Caption = 
        ...
        's a Receber'#13#10'- Tesouraria'#13#10'- Banco'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clGreen
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
  ...
  inherited TblTemporaria: TTable
    ...
    object TblTemporariaRECEITA: TBCDField
      FieldName = 'RECEITA'
      Precision = 15
      Size = 3
    end
    object TblTemporariaDESPESA: TBCDField
      FieldName = 'DESPESA'
      Precision = 15
      Size = 3
    end
    object TblTemporariaVALOR: TBCDField
      FieldName = 'VALOR'
      Size = 3
    end
    object TblTemporariaPERC: TBCDField
      FieldName = 'PERC'
      Size = 3
    end
  ...
  object SQLReceitas: TRxQuery
    ...
    SQL.Strings = (
      ...
      '(CONTASRECEBER.CTRCA5TIPOPADRAO not in('#39'CHQ'#39','#39'CHQV'#39','#39'CHQP'#39')) and'
      '(%MDataRecebido) and'
      '(%MEmpresaRecebido)'
      'group by'
      '    PLANODECONTAS.PLCTA15COD,'
    ...
    object SQLReceitasRECEITA: TBCDField
      FieldName = 'RECEITA'
      Precision = 15
      Size = 3
    end
    object SQLReceitasDESPESA: TBCDField
      FieldName = 'DESPESA'
      Precision = 15
      Size = 3
    end
  ...
  object SQLAux: TQuery
    ...
    object SQLAuxRECEITA: TBCDField
      FieldName = 'RECEITA'
      Precision = 15
      Size = 3
    end
    object SQLAuxDESPESA: TBCDField
      FieldName = 'DESPESA'
      Precision = 15
      Size = 3
    end
  ...
  object SQLPlanoContas: TRxQuery
    ...
    object SQLPlanoContasRECEITA: TBCDField
      FieldName = 'RECEITA'
      Precision = 15
      Size = 3
    end
    object SQLPlanoContasDESPESA: TBCDField
      FieldName = 'DESPESA'
      Precision = 15
      Size = 3
    end
    object SQLPlanoContasVALOR: TBCDField
      FieldName = 'VALOR'
      Size = 3
    end
    object SQLPlanoContasPERC: TBCDField
      FieldName = 'PERC'
      Size = 3
    end
  end
  object TblRegistros: TTable
    ...
    object TblRegistrosRECEITA: TBCDField
      FieldName = 'RECEITA'
      Precision = 15
      Size = 3
    end
    object TblRegistrosDESPESA: TBCDField
      FieldName = 'DESPESA'
      Precision = 15
      Size = 3
    end
  ...
  object SQLContasReceber: TRxQuery
    ...
    object SQLContasReceberVALOR: TBCDField
      FieldName = 'VALOR'
      Precision = 15
      Size = 3
    end
  ...
  object TblLancamentos: TTable
    ...
    object TblLancamentosVALOR: TBCDField
      FieldName = 'VALOR'
      Precision = 15
      Size = 3
    end
  ...
  object SQLContasPagar: TRxQuery
    ...
    object SQLContasPagarVALOR: TBCDField
      FieldName = 'VALOR'
      Precision = 15
      Size = 2
    end
  ...
  object SQLTesourariaLanc: TRxQuery
    ...
    object SQLTesourariaLancVALOR: TBCDField
      FieldName = 'VALOR'
      Precision = 15
      Size = 3
    end
  ...
  object SQLMovimentoBanco: TRxQuery
    ...
    object SQLMovimentoBancoDESPESA: TBCDField
      FieldName = 'DESPESA'
      Origin = 'DB.MOVIMENTOBANCO.MVBCN2VLRDEB'
      Precision = 15
      Size = 3
    end
    object SQLMovimentoBancoRECEITA: TBCDField
      FieldName = 'RECEITA'
  ...
  object SQLBancoLanc: TRxQuery
    ...
    object SQLBancoLancVALOR: TBCDField
      FieldName = 'VALOR'
      Precision = 15
      Size = 3
    end
  ...
  object SQLPagamentoJuros: TRxQuery
    ...
    object SQLPagamentoJurosRECEITA: TBCDField
      FieldName = 'RECEITA'
      Precision = 15
      Size = 3
    end
  ...
  object SQLPagamentoMultas: TRxQuery
    ...
    object SQLPagamentoMultasRECEITA: TBCDField
      FieldName = 'RECEITA'
      Precision = 15
      Size = 3
    end
  ...
  object SQLPagamentoDesconto: TRxQuery
    ...
    object SQLPagamentoDescontoRECEITA: TBCDField
      FieldName = 'RECEITA'
      Precision = 15
      Size = 3
    end
