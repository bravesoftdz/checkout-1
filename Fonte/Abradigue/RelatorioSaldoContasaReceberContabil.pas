...
type
  TFormRelatorioSaldoContasReceberContabil = class(TFormRelatorioTEMPLATE)
    ...
    SQLContasReceberCCTRCN2VLR: TBCDField;
    SQLContasReceberCEMPRICODULTREC: TIntegerField;
    SQLContasReceberCDTULTREC: TStringField;
    SQLContasReceberCCTRCN2TOTREC: TBCDField;
    SQLContasReceberCCTRCN2TXJURO: TBCDField;
    SQLContasReceberCCTRCN2TXMULTA: TBCDField;
    SQLContasReceberCCTRCN2TOTDESCREC: TBCDField;
