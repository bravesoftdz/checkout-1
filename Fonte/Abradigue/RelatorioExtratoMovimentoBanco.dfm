inherited FormRelatorioExtratoMovimentoBanco: TFormRelatorioExtratoMovimentoBanco
  Left = 100
  Top = 133
  Caption = 'Relat'#243'rio de Extrato de Movimento Banc'#225'rio'
  PixelsPerInch = 96
  TextHeight = 13
  inherited ScrollBox: TScrollBox
    inherited PanelCentro: TPanel
      ...
      object GroupBox2: TGroupBox
        ...
        object ComboConta: TDBLookupComboBox
          Left = 6
          Top = 16
          Width = 57
          Height = 21
  ...
  object SQLCC: TRxQuery
    ...
    object SQLCCCTCRN2LIMITE: TBCDField
      FieldName = 'CTCRN2LIMITE'
      Origin = 'DB.CONTACORRENTE.CTCRN2LIMITE'
      Precision = 15
      Size = 3
    end
    object SQLCCCTCRN2SALDOATUAL: TBCDField
