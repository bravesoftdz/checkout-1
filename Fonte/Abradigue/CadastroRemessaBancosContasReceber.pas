...
begin
  ...
  CriaFormulario(TFormCadastroContasReceber, 'FormCadastroContasReceber', False, True, '') ;
end;
...
begin
  ...
  CriaFormulario(TFormTelaRemessaDocumentosReceber,'FormTelaRemessaDocumentosReceber', False, False, '');
end;
