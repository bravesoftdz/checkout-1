...
type
  TFormCadastroTesouraria = class(TFormCadastroTEMPLATE)
    ...
    SQLTemplateTESON2VLRDEBITO: TBCDField;
    SQLTemplateTESON2VLRCREDITO: TBCDField;
...
begin
  ...
  CriaFormulario(TFormCadastroOperacaoTesouraria,'FormCadastroOperacaoTesouraria',False,True,'');
end;
...
begin
  ...
  if SQLTemplateTipoOperacaoCalc.AsString = 'C' then
    ...
    TipoPlanoContas := 'D';
  CriaFormulario(TFormTelaConsultaPlanoContas, 'FormTelaConsultaPlanoContas', False, True, '');
end;
...
begin
  ...
  CriaFormulario(TFormCadastroHistoricoPadrao, 'FormCadastroHistoricoPadrao', False, True, 'Caixa Tesouraria');
end;
