...
type
  TFormCadastroChequeEmitido = class(TFormCadastroTEMPLATE)
    ...
    SQLTemplateCQEMN3VLR: TBCDField;
...
begin
  ...
  CriaFormulario(TFormTelaConsultaEmpresa,'FormTelaConsultaEmpresa',False,True,'Cadastro de Cheques Emitidos');
end;
...
begin
  ...
  CriaFormulario(TFormCadastroContaCorrente,'FormCadastroContaCorrente',False,True,'Cadastro de Cheques Emitidos');
end;
