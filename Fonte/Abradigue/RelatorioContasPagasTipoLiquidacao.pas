...
type
  TFormRelatorioContasPagasTipoLiquidacao = class(TFormRelatorioTEMPLATE)
    ...
    SQLPagamentoVALOR: TBCDField;
    SQLPagamentoJUROS: TBCDField;
    SQLPagamentoMULTA: TBCDField;
    SQLPagamentoDESCONTO: TBCDField;
    SQLContasPagarCTPGA13ID: TStringField;
    SQLContasPagarPAGAN3VLRPAGTO: TBCDField;
    SQLContasPagarSALDO: TBCDField;
    SQLContasPagarPAGAN3VLRJURO: TBCDField;
    SQLContasPagarPAGAN3VLRMULTA: TBCDField;
    SQLContasPagarPAGAN3VLRDESC: TBCDField;
