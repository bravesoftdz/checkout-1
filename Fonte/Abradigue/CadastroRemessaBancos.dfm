inherited FormCadastroRemessaBancos: TFormCadastroRemessaBancos
  ...
  inherited PopupMenuDiversos: TPopupMenu
    object CriarArquivodeRemessa1: TMenuItem
      ...
      object MnADMRemBancodoBrasil: TMenuItem
        Caption = 'Banco do Brasil'
        OnClick = MnADMRemBancodoBrasilClick
      end
  ...
  inherited SQLTemplate: TRxQuery
    ...
    object SQLTemplateRMBCN2VLRDIAATRASO: TBCDField
      ConstraintErrorMessage = '1'
    ...
    object SQLTemplateRMBCN2VLRDESCONTO: TBCDField
      ConstraintErrorMessage = '1'
  ...
  object SQLContaReceber: TRxQuery
    ...
    object SQLContaReceberCTRCN2VLR: TBCDField
      FieldName = 'CTRCN2VLR'
      Origin = 'DB.CONTASRECEBER.CTRCN2VLR'
      Precision = 15
      Size = 3
    end
    object SQLContaReceberCTRCN2DESCFIN: TBCDField
    ...
    object SQLContaReceberCTRCN2TXJURO: TBCDField
      FieldName = 'CTRCN2TXJURO'
      Origin = 'DB.CONTASRECEBER.CTRCN2TXJURO'
      Precision = 15
      Size = 3
    end
    object SQLContaReceberCTRCN2TXMULTA: TBCDField
