unit TelaBaixarDocumentosReceberPlanoConta;
...
uses
  ...
  RxLookup, ComCtrls, DB, DBTables, RxQuery, IniFiles;

type
  TFormTelaBaixarDocumentosReceberPlanoConta = class(TFormTelaGeralModalTemplate)
...
var
  FormTelaBaixarDocumentosReceberPlanoConta: TFormTelaBaixarDocumentosReceberPlanoConta;
...
procedure TFormTelaBaixarDocumentosReceberPlanoConta.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TFormTelaBaixarDocumentosReceberPlanoConta.BtnFecharTelaClick(Sender: TObject);
begin
  inherited;
  FormTelaBaixarDocumentosReceberPlanoConta.ModalResult := MrCancel;
end;

procedure TFormTelaBaixarDocumentosReceberPlanoConta.ButtongerarClick(
  Sender: TObject);
begin
  inherited;
  ...
  FormTelaBaixarDocumentosReceberPlanoConta.ModalResult := MrOk;
end;

procedure TFormTelaBaixarDocumentosReceberPlanoConta.FormClose(
