...
begin
  ...
  CriaFormulario(TFormCadastroClienteContatos,'FormCadastroClienteContatos', True, False,False,'');
end;
...
begin
  ...
  CriaFormulario(TFormCadastroHistorico,'FormCadastroHistorico',False,False,True,'Cliente');
end;
