...
begin
  ...
  if dm.SQLConfigCompraCFCOCPREVREALNFCOMPRAFIN.AsString <> '' then
    SQLTemplateCTPGCPREVREAL.Value    := dm.SQLConfigCompraCFCOCPREVREALNFCOMPRAFIN.AsString
  else
