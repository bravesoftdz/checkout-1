inherited FormRelatorioContasPagasTipoLiquidacao: TFormRelatorioContasPagasTipoLiquidacao
  ...
  object SQLContasPagar: TRxQuery
    ...
    object SQLContasPagarPAGAN3VLRPAGTO: TBCDField
      FieldName = 'PAGAN3VLRPAGTO'
      Precision = 15
      Size = 2
    end
    object SQLContasPagarSALDO: TBCDField
      FieldName = 'SALDO'
      Precision = 15
      Size = 2
    end
    object SQLContasPagarPAGAN3VLRJURO: TBCDField
      FieldName = 'PAGAN3VLRJURO'
      Precision = 15
      Size = 3
    end
    object SQLContasPagarPAGAN3VLRMULTA: TBCDField
      FieldName = 'PAGAN3VLRMULTA'
      Precision = 15
      Size = 3
    end
    object SQLContasPagarPAGAN3VLRDESC: TBCDField
      FieldName = 'PAGAN3VLRDESC'
      Precision = 15
      Size = 3
    end
  ...
  object SQLPagamento: TRxQuery
    ...
    object SQLPagamentoVALOR: TBCDField
      FieldName = 'VALOR'
      Origin = 'DB.PAGAMENTO.PAGAN3VLRPAGTO'
      Precision = 15
      Size = 2
    end
    object SQLPagamentoJUROS: TBCDField
      FieldName = 'JUROS'
      Origin = 'DB.PAGAMENTO.PAGAN3VLRJURO'
      Precision = 15
      Size = 3
    end
    object SQLPagamentoMULTA: TBCDField
      FieldName = 'MULTA'
      Origin = 'DB.PAGAMENTO.PAGAN3VLRMULTA'
      Precision = 15
      Size = 3
    end
    object SQLPagamentoDESCONTO: TBCDField
      FieldName = 'DESCONTO'
