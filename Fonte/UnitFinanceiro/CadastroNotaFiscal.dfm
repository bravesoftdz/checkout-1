inherited FormCadastroNotaFiscal: TFormCadastroNotaFiscal
            ...
            inherited TabSheetConsulta: TTabSheet
              ...
              object GroupBox5: TGroupBox
                ...
                object AdvGlowButton1: TAdvGlowButton
                  ...
                  Width = 88
                  Height = 81
                  Caption = 'Imprime NFE Selecionada'
                  Font.Charset = DEFAULT_CHARSET
                  Font.Color = clBlack
                  Font.Height = -11
                  Font.Name = 'MS Sans Serif'
  ...
  inherited PopupMenuDiversos: TPopupMenu
    object NotaFiscalEletronicaMIGRATE1: TMenuItem
      Caption = 
        '------------------ Nota Fiscal Eletronica - CONCEITOS ----------' +
        '----------'
      Enabled = False
    end
    ...
    object MnImportarDadosdoPedidodeVenda: TMenuItem
      Caption = '&Importar Dados do Pedido de Venda'
    end
    object VerificarStatusdaNFe1: TMenuItem
      Caption = 'Verificar Status da NFe'
      Visible = False
      OnClick = VerificarStatusdaNFe1Click
    end
    object N7: TMenuItem
      Caption = '-'
    end
    ...
    object NotaFiscalEletronica1: TMenuItem
      Caption = 
        '------------------ Nota Fiscal Eletronica - MIGRATE ------------' +
        '--------'
      Enabled = False
      Visible = False
    end
    object MnNFEGerarArquivoEnvio: TMenuItem
      Caption = 'Gerar Arquivo(s) de Envio (XML) para Nota(s) Listadas'
      Visible = False
      OnClick = MnNFEGerarArquivoEnvioClick
    end
    object MnNFERetornoNotaEletronica: TMenuItem
      Caption = 'Capturar Retorno(s) Notas Fiscais'
      Visible = False
      OnClick = MnNFERetornoNotaEletronicaClick
    end
    object MnNFECancelamentoNotaEletronica: TMenuItem
      Caption = 'Cancelamento Nota Eletronica Atual'
      Visible = False
      OnClick = MnNFECancelamentoNotaEletronicaClick
    end
    object rocarStatusdaNFeparaNull1: TMenuItem
      Caption = 'Trocar Status da NF-e para Null'
      Visible = False
      OnClick = rocarStatusdaNFeparaNull1Click
    end
    object N2: TMenuItem
      Caption = '-'
    end
  ...
  inherited PopupMenuImpressao: TPopupMenu
    ...
    object ImprimirNotaNovo1: TMenuItem
      Caption = 'Imprimir Nota (Novo)'
      Visible = False
      OnClick = ImprimirNotaNovo1Click
    end
    ...
    object ImprimirDuplicatas1: TMenuItem
      Caption = '&Bloqueto / Duplicatas'
    end
    object N1: TMenuItem
      Caption = '-'
    end
    object GeradorGNFeDesktopEdition1: TMenuItem
      Caption = '=============> Gerador GNF-e Desktop Edition <================='
      Enabled = False
    end
    object N6: TMenuItem
      Caption = '-'
    end
    object NotaFiscalEletrnicaListadas1: TMenuItem
      Caption = 'Imprimir  Nota Fiscal Eletr'#244'nica com GNF-e Desktop Edition'
      OnClick = MnNFEGerarArquivoEnvioClick
    end
    object N5: TMenuItem
      Caption = '-'
    end
    object GeradordeNFeAtualy1: TMenuItem
      Caption = '=================> Gerador de NF-e <=================='
      Enabled = False
    end
    object N3: TMenuItem
      Caption = '-'
    ...
    object otasasNotasFiscaisEletronicasListadas1: TMenuItem
      Caption = 
        'Imprimir Todas as Notas Fiscais Eletronicas Listadas com Atualy ' +
        'NF-e'
      OnClick = otasasNotasFiscaisEletronicasListadas1Click
    end
    object N4: TMenuItem
      Caption = '-'
    end
  ...
  inherited SQLTemplate: TRxQuery
    ...
    object SQLTemplateCampoImpostoLookUp: TStringField
      ...
      LookupDataSet = SQLOperacaEstoque
  ...
  object SQLOperacaEstoque: TTable
    ...
    object SQLOperacaEstoqueOPESA18CAMPOIMPFIS: TStringField
      FieldName = 'OPESA18CAMPOIMPFIS'
      FixedChar = True
      Size = 18
    end
    object SQLOperacaEstoqueOPESCCALCICMSFIS: TStringField
      FieldName = 'OPESCCALCICMSFIS'
      FixedChar = True
      Size = 1
    end
    object SQLOperacaEstoqueOPESCCALCIPIFIS: TStringField
      FieldName = 'OPESCCALCIPIFIS'
      FixedChar = True
      Size = 1
    end
    object SQLOperacaEstoqueOPESCCALCSUBST: TStringField
      FieldName = 'OPESCCALCSUBST'
      FixedChar = True
      Size = 1
    end
    object SQLOperacaEstoqueOPESCCALCSUBSTFIS: TStringField
      FieldName = 'OPESCCALCSUBSTFIS'
      FixedChar = True
      Size = 1
    end
    object SQLOperacaEstoqueOPESA60DESDENTRO: TStringField
      FieldName = 'OPESA60DESDENTRO'
      Size = 60
    end
    object SQLOperacaEstoqueOPESA60DESFORA: TStringField
  ...
  object ACBrNFe1: TACBrNFe
    Configuracoes.Geral.PathSalvar = 'C:\Unit\NFe\'
    ...
    Configuracoes.Arquivos.PathNFe = 'C:\Unit\NFe\emitidos'
    Configuracoes.Arquivos.PathCan = 'C:\Unit\NFe\emitidos'
    Configuracoes.Arquivos.PathInu = 'C:\Unit\NFe\emitidos'
    Configuracoes.Arquivos.PathDPEC = 'C:\Unit\NFe\emitidos'
    Configuracoes.Arquivos.PathCCe = 'C:\Unit\NFe\emitidos'
  ...
  object ACBrNFeDANFERave1: TACBrNFeDANFERave
    ACBrNFe = ACBrNFe1
    Sistema = 'Multistore Sistemas'
    PathPDF = 'C:\Unit\NFe\emitidos\'
    MostrarPreview = True
    MostrarStatus = True
    TipoDANFE = tiRetrato
    NumCopias = 2
    ...
    NFeCancelada = False
    RavFile = 'C:\Unit\NFe\rel\NotaFiscalEletronica.rav'
    EspessuraBorda = 1
  ...
  object cdsEmpresa: TClientDataSet
    ...
    object cdsEmpresaEMPRA60NOMEFANT: TStringField
      FieldName = 'EMPRA60NOMEFANT'
      FixedChar = True
      Size = 60
    end
    object cdsEmpresaEMPRCMATRIZFILIAL: TStringField
      FieldName = 'EMPRCMATRIZFILIAL'
      FixedChar = True
      Size = 1
    end
    object cdsEmpresaEMPRA20FONE: TStringField
      FieldName = 'EMPRA20FONE'
      FixedChar = True
    end
    object cdsEmpresaEMPRA20FAX: TStringField
      FieldName = 'EMPRA20FAX'
      FixedChar = True
    end
    object cdsEmpresaEMPRA60END: TStringField
      FieldName = 'EMPRA60END'
      FixedChar = True
      Size = 60
    end
    object cdsEmpresaEMPRA60BAI: TStringField
      FieldName = 'EMPRA60BAI'
      FixedChar = True
      Size = 60
    end
    object cdsEmpresaEMPRA60CID: TStringField
      FieldName = 'EMPRA60CID'
      FixedChar = True
      Size = 60
    end
    object cdsEmpresaEMPRA2UF: TStringField
      FieldName = 'EMPRA2UF'
      FixedChar = True
      Size = 2
    end
    object cdsEmpresaEMPRA8CEP: TStringField
      FieldName = 'EMPRA8CEP'
      FixedChar = True
      Size = 8
    end
    object cdsEmpresaEMPRCFISJURID: TStringField
      FieldName = 'EMPRCFISJURID'
      FixedChar = True
      Size = 1
    end
    object cdsEmpresaEMPRA14CGC: TStringField
      FieldName = 'EMPRA14CGC'
      FixedChar = True
      Size = 14
    end
    object cdsEmpresaEMPRA20IE: TStringField
      FieldName = 'EMPRA20IE'
      FixedChar = True
    end
    object cdsEmpresaEMPRA11CPF: TStringField
      FieldName = 'EMPRA11CPF'
      FixedChar = True
      Size = 11
    end
    object cdsEmpresaEMPRA10RG: TStringField
      FieldName = 'EMPRA10RG'
      FixedChar = True
      Size = 10
    end
    object cdsEmpresaEMPRA60EMAIL: TStringField
      FieldName = 'EMPRA60EMAIL'
      FixedChar = True
      Size = 60
    end
    object cdsEmpresaEMPRA60URL: TStringField
      FieldName = 'EMPRA60URL'
      FixedChar = True
      Size = 60
    end
    object cdsEmpresaPENDENTE: TStringField
      FieldName = 'PENDENTE'
      FixedChar = True
      Size = 1
    end
    object cdsEmpresaREGISTRO: TSQLTimeStampField
      FieldName = 'REGISTRO'
    end
    object cdsEmpresaEMPRA100INFSPC: TStringField
      FieldName = 'EMPRA100INFSPC'
      FixedChar = True
      Size = 100
    end
    object cdsEmpresaEMPRBLOGOTIPO: TBlobField
      FieldName = 'EMPRBLOGOTIPO'
      Size = 1
    end
    object cdsEmpresaEMPRA15CODEAN: TStringField
      FieldName = 'EMPRA15CODEAN'
      FixedChar = True
      Size = 15
    end
    object cdsEmpresaEMPRA60CONTATO: TStringField
      FieldName = 'EMPRA60CONTATO'
      FixedChar = True
      Size = 60
    end
    object cdsEmpresaEMPRCLUCROREAL: TStringField
      FieldName = 'EMPRCLUCROREAL'
      FixedChar = True
      Size = 1
    end
    object cdsEmpresaEMPRN2VLRFUNDOPROMO: TFMTBCDField
      FieldName = 'EMPRN2VLRFUNDOPROMO'
      Precision = 15
      Size = 2
    end
    object cdsEmpresaEMPRA15REGJUNTA: TStringField
      FieldName = 'EMPRA15REGJUNTA'
      FixedChar = True
      Size = 15
    end
    object cdsEmpresaEMPRA20IMUNIC: TStringField
      FieldName = 'EMPRA20IMUNIC'
      FixedChar = True
    end
    object cdsEmpresaNOMETECNICOAGRIC: TStringField
      FieldName = 'NOMETECNICOAGRIC'
      FixedChar = True
      Size = 60
    end
    object cdsEmpresaENDTECNICOAGRIC: TStringField
      FieldName = 'ENDTECNICOAGRIC'
      FixedChar = True
      Size = 60
    end
    object cdsEmpresaCIDTECNICOAGRIC: TStringField
      FieldName = 'CIDTECNICOAGRIC'
      FixedChar = True
      Size = 60
    end
    object cdsEmpresaCPFTECNICOAGRIC: TStringField
      FieldName = 'CPFTECNICOAGRIC'
      FixedChar = True
    end
    object cdsEmpresaCREATECNICOAGRIC: TStringField
      FieldName = 'CREATECNICOAGRIC'
      FixedChar = True
    end
    object cdsEmpresaSERIE: TStringField
      FieldName = 'SERIE'
      FixedChar = True
      Size = 15
    end
    object cdsEmpresaARTIGO: TStringField
      FieldName = 'ARTIGO'
      FixedChar = True
      Size = 10
    end
    object cdsEmpresaNRORECEITATUAL: TIntegerField
      FieldName = 'NRORECEITATUAL'
    end
    object cdsEmpresaNRORECEITAULT: TIntegerField
      FieldName = 'NRORECEITAULT'
    end
    object cdsEmpresaEMPRA20CPFCONTADOR: TStringField
      FieldName = 'EMPRA20CPFCONTADOR'
    end
    object cdsEmpresaEMPRA20CPFRESP: TStringField
      FieldName = 'EMPRA20CPFRESP'
    end
    object cdsEmpresaEMPRA30CRC: TStringField
      FieldName = 'EMPRA30CRC'
      Size = 30
    end
    object cdsEmpresaEMPRA40CARGOCONT: TStringField
      FieldName = 'EMPRA40CARGOCONT'
      Size = 40
    end
    object cdsEmpresaEMPRA40CARGORESP: TStringField
      FieldName = 'EMPRA40CARGORESP'
      Size = 40
    end
    object cdsEmpresaEMPRA60CONTADOR: TStringField
      FieldName = 'EMPRA60CONTADOR'
      Size = 60
    end
    object cdsEmpresaEMPRIENDNRO: TIntegerField
      FieldName = 'EMPRIENDNRO'
    end
    object cdsEmpresaEMPRIMUNICODFED: TIntegerField
      FieldName = 'EMPRIMUNICODFED'
    end
    object cdsEmpresaEMPRIUFCODFED: TIntegerField
      FieldName = 'EMPRIUFCODFED'
    end
    object cdsEmpresaEMPRDREGJUNTA: TSQLTimeStampField
      FieldName = 'EMPRDREGJUNTA'
    end
    object cdsEmpresaEMPRA3CRT: TStringField
      FieldName = 'EMPRA3CRT'
      Size = 3
    end
    object cdsEmpresaEMPRN2CREDICMS: TFMTBCDField
      FieldName = 'EMPRN2CREDICMS'
      Precision = 15
      Size = 2
    end
    object cdsEmpresaEMPRA10FAXCONTADOR: TStringField
      FieldName = 'EMPRA10FAXCONTADOR'
      Size = 10
    end
    object cdsEmpresaEMPRA10FONECONTADOR: TStringField
      FieldName = 'EMPRA10FONECONTADOR'
      Size = 10
    end
    object cdsEmpresaEMPRA14CNPJCONTADOR: TStringField
      FieldName = 'EMPRA14CNPJCONTADOR'
      Size = 14
    end
    object cdsEmpresaEMPRA60BAICONTADOR: TStringField
      FieldName = 'EMPRA60BAICONTADOR'
      Size = 60
    end
    object cdsEmpresaEMPRA60ENDCONTADOR: TStringField
      FieldName = 'EMPRA60ENDCONTADOR'
      Size = 60
    end
    object cdsEmpresaEMPRA7CODMUNCONTADOR: TStringField
      FieldName = 'EMPRA7CODMUNCONTADOR'
      Size = 7
    end
    object cdsEmpresaEMPRA8CEPCONTADOR: TStringField
      FieldName = 'EMPRA8CEPCONTADOR'
      Size = 8
    end
    object cdsEmpresaEMPRA15CRCCONTADOR: TStringField
      FieldName = 'EMPRA15CRCCONTADOR'
      Size = 15
    end
    object cdsEmpresaEMPRIATIVIDADE: TIntegerField
      FieldName = 'EMPRIATIVIDADE'
    end
    object cdsEmpresaEMPRA150CONTADOREMAIL: TStringField
      FieldName = 'EMPRA150CONTADOREMAIL'
      Size = 150
    end
    object cdsEmpresaEMPRA2NATPJ: TStringField
      FieldName = 'EMPRA2NATPJ'
      FixedChar = True
      Size = 2
    end
    object cdsEmpresaEMPRA9SUFRAMA: TStringField
      FieldName = 'EMPRA9SUFRAMA'
      Size = 9
    end
    object cdsEmpresaCNAEFISCAL: TStringField
      FieldName = 'CNAEFISCAL'
      Size = 15
    end
    object cdsEmpresaEMPRA100CERTIFSERIE: TStringField
      FieldName = 'EMPRA100CERTIFSERIE'
      Size = 100
    end
    object cdsEmpresaEMPRA35CERTIFSENHA: TStringField
      FieldName = 'EMPRA35CERTIFSENHA'
      Size = 35
    end
    object cdsEmpresaEMPRIFORMAEMISDANFE: TIntegerField
      FieldName = 'EMPRIFORMAEMISDANFE'
    end
    object cdsEmpresaEMPRIFORMAEMISNFE: TIntegerField
      FieldName = 'EMPRIFORMAEMISNFE'
    end
    object cdsEmpresaEMPRA100CAMINHOLOGO: TStringField
      FieldName = 'EMPRA100CAMINHOLOGO'
      Size = 100
    end
    object cdsEmpresaEMPRA100CAMINHOXML: TStringField
      FieldName = 'EMPRA100CAMINHOXML'
      Size = 100
    end
    object cdsEmpresaEMPRA100CAMINHODANFES: TStringField
      FieldName = 'EMPRA100CAMINHODANFES'
      Size = 100
    end
    object cdsEmpresaEMPRA2WSUF: TStringField
      FieldName = 'EMPRA2WSUF'
      Size = 2
    end
    object cdsEmpresaEMPRIWSAMBIENTE: TIntegerField
      FieldName = 'EMPRIWSAMBIENTE'
    end
    object cdsEmpresaEMPRA1VISUALIZAMSG: TStringField
      FieldName = 'EMPRA1VISUALIZAMSG'
      FixedChar = True
      Size = 1
    end
    object cdsEmpresaEMPRA100PROXYHOST: TStringField
      FieldName = 'EMPRA100PROXYHOST'
      Size = 100
    end
    object cdsEmpresaEMPRIPROXYPORTA: TIntegerField
      FieldName = 'EMPRIPROXYPORTA'
    end
    object cdsEmpresaEMPRA50PROXYUSUARIO: TStringField
      FieldName = 'EMPRA50PROXYUSUARIO'
      Size = 50
    end
    object cdsEmpresaEMPRA50PROXYSENHA: TStringField
      FieldName = 'EMPRA50PROXYSENHA'
      Size = 50
    end
    object cdsEmpresaEMPRA50EMAILHOST: TStringField
      FieldName = 'EMPRA50EMAILHOST'
      Size = 50
    end
    object cdsEmpresaEMPRIEMAILPORTA: TIntegerField
      FieldName = 'EMPRIEMAILPORTA'
    end
    object cdsEmpresaEMPRA75EMAILUSUARIO: TStringField
      FieldName = 'EMPRA75EMAILUSUARIO'
      Size = 75
    end
    object cdsEmpresaEMPRA50EMAILSENHA: TStringField
