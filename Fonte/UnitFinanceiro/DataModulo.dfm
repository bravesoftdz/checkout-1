inherited DM: TDM
  ...
  object SQLConfigGeral: TQuery
    ...
    object SQLConfigGeralCFGECFATURAMENSAL: TStringField
      FieldName = 'CFGECFATURAMENSAL'
      Origin = 'DB.CONFIGGERAL.CFGECFATURAMENSAL'
      FixedChar = True
      Size = 1
    end
    object SQLConfigGeralCFGEDFATURAMENSAL: TDateTimeField
      FieldName = 'CFGEDFATURAMENSAL'
      Origin = 'DB.CONFIGGERAL.CFGEDFATURAMENSAL'
    end
  end
