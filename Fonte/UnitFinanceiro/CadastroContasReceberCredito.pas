unit CadastroContasReceberCredito;
...
type
  TFormCadastroContasReceberCredito = class(TFormCadastroTEMPLATE)
...
var
  FormCadastroContasReceberCredito: TFormCadastroContasReceberCredito;
...
procedure TFormCadastroContasReceberCredito.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TFormCadastroContasReceberCredito.SQLTemplateCalcFields(
  DataSet: TDataSet);
begin
  inherited;
  //EMPRESA
...
procedure TFormCadastroContasReceberCredito.BtnClienteClick(Sender: TObject);
begin
  inherited;
...
procedure TFormCadastroContasReceberCredito.RetornaTipoDocClick(Sender: TObject);
begin
  inherited;
...
procedure TFormCadastroContasReceberCredito.RetornaPortadorClick(Sender: TObject);
begin
  inherited;
...
procedure TFormCadastroContasReceberCredito.RetornaPlanoContasClick(
  Sender: TObject);
begin
  inherited;
...
procedure TFormCadastroContasReceberCredito.Geraroutrolanamentoapartirdodocumentoatual1Click(
  Sender: TObject);
var
...
procedure TFormCadastroContasReceberCredito.DBEdit7KeyDown(Sender: TObject;
...
procedure TFormCadastroContasReceberCredito.SQLTemplateNUMEICODChange(Sender: TField);
begin
  inherited;
  SQLTemplateCTRCA5TIPOPADRAO.AsVariant := SQLTemplateTipoPadraoCalcField.AsVariant ;
end;

procedure TFormCadastroContasReceberCredito.SQLTemplateNewRecord(DataSet: TDataSet);
begin
  inherited ;
  ...
  DataSet.FieldByName('CTRCDVENC').AsDateTime    := DataSet.FieldByName('CTRCDEMIS').AsDateTime;
  // Tipo de Registro no Contas a Receber -> N = Normal C = Credito D = Debito;
  DataSet.FieldByName('CTRCCTIPOREGISTRO').Value := 'C';

end ;

procedure TFormCadastroContasReceberCredito.BtnEmpresaClick(Sender: TObject);
begin
  inherited;
...
procedure TFormCadastroContasReceberCredito.SpeedButton1Click(Sender: TObject);
var
Clausula : String;
CampoOrdem : TField;
begin
...
procedure TFormCadastroContasReceberCredito.SpeedButton2Click(Sender: TObject);
begin
  inherited;
  ComboCliente.Value  := '';
  ComboConta.Value    := '';
...
procedure TFormCadastroContasReceberCredito.ComboClienteKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  inherited;
...
procedure TFormCadastroContasReceberCredito.DSTemplateDataChange(Sender: TObject;
  Field: TField);
begin
  inherited;
...
procedure TFormCadastroContasReceberCredito.SQLTemplateBeforeDelete(
  DataSet: TDataSet);
var
 Posicao : TBookMark;
begin
...
procedure TFormCadastroContasReceberCredito.SQLTemplateHTPDICODChange(
  Sender: TField);
begin
  inherited;
  //HISTORICO PADRAO
...
procedure TFormCadastroContasReceberCredito.BtnHistoricoClick(Sender: TObject);
begin
  inherited;
...
procedure TFormCadastroContasReceberCredito.DBEditHistoricoPadraoExit(Sender: TObject);
var
  Tam : Integer;
begin
  inherited;
...
procedure TFormCadastroContasReceberCredito.DBEditHistoricoPadraoKeyDown(
...
procedure TFormCadastroContasReceberCredito.RetornaPlanoContasDebitoClick(
  Sender: TObject);
begin
  inherited;
...
procedure TFormCadastroContasReceberCredito.DBEdit5KeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  inherited;
  if Key = VK_F2 then
...
procedure TFormCadastroContasReceberCredito.DBGrid1DblClick(Sender: TObject);
begin
  inherited;
...
procedure TFormCadastroContasReceberCredito.SQLContasReceberBeforePost(
  DataSet: TDataSet);
begin
  inherited;
...
procedure TFormCadastroContasReceberCredito.SQLContasReceberPostError(
...
procedure TFormCadastroContasReceberCredito.FormClose(Sender: TObject;
...
procedure TFormCadastroContasReceberCredito.ComboEmpresaKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  inherited;
  if key = Vk_Return then
...
procedure TFormCadastroContasReceberCredito.ComboClienteCadKeyDown(
  Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
  if key = Vk_Return then
...
procedure TFormCadastroContasReceberCredito.ComboTipoDocCadKeyDown(
  Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
  if key = Vk_Return then
...
procedure TFormCadastroContasReceberCredito.ComboPortadorCadKeyDown(
  Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
  if key = Vk_Return then
