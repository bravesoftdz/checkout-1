...
type
  TFormRelatorioSaldoDiarioTesouraria = class(TFormRelatorioTEMPLATE)
    ...
    SQLSaldoTesourariaCREDITO: TBCDField;
    SQLSaldoTesourariaDEBITO: TBCDField;
    ...
    SQLChequeRecebidoSALDO: TBCDField;
    SQLChequeEmitidoSALDO: TBCDField;
    ...
    SQLChequeRecebidoDepositadoSALDO: TBCDField;
    SQLChequeRecebidoDepositadoEMPRICOD: TIntegerField;
    SQLChequeEmitidoDepositadoSALDO: TBCDField;
