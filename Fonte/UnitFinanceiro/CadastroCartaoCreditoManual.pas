...
type
  TFormCadastroCartaoCreditoManual = class(TFormCadastroTEMPLATE)
    ...
    SQLTemplateCUPON2DESCITENS: TBCDField;
    ...
    SQLTemplateCUPON2BASEICMS: TBCDField;
    SQLTemplateCUPON2VLRICMS: TBCDField;
...
begin
  ...
  SQLTemplateCUPON2JUROATRAS.Value      := dm.SQLConfigCrediarioCFCRN2PERCJURATRAS.Value;
  SQLTemplateCUPON2MULTAATRAS.Value     := dm.SQLConfigCrediarioCFCRN2PERCMULATRAS.Value;
  ...
  SQLTemplateCFOPA5COD.Value            := dm.SQLLocate('OPERACAOESTOQUE','OPESICOD','CFOPA5CODDENTROUF',dm.SQLConfigVendaOPESICODCUPOM.asString);            
