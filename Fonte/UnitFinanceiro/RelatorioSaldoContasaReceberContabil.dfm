inherited FormRelatorioSaldoContasReceberContabil: TFormRelatorioSaldoContasReceberContabil
  ...
  object SQLRecebimento: TRxQuery
    ...
    object SQLRecebimentoSUM: TBCDField
      FieldName = 'SUM'
  ...
  object TbReceberCred: TTable
    ...
    object TbReceberCredCTRCN2VLR: TBCDField
      FieldName = 'CTRCN2VLR'
      Precision = 15
      Size = 3
    end
    ...
    object TbReceberCredCTRCN2TOTREC: TBCDField
      FieldName = 'CTRCN2TOTREC'
      Precision = 15
      Size = 3
    end
  ...
  object SQLContasReceberC: TRxQuery
    ...
    object SQLContasReceberCCTRCN2VLR: TBCDField
      FieldName = 'CTRCN2VLR'
      Precision = 15
      Size = 3
    end
    ...
    object SQLContasReceberCCTRCN2TOTREC: TBCDField
      FieldName = 'CTRCN2TOTREC'
      Precision = 15
      Size = 3
    end
    object SQLContasReceberCCTRCN2TXJURO: TBCDField
      FieldName = 'CTRCN2TXJURO'
      Precision = 15
      Size = 3
    end
    object SQLContasReceberCCTRCN2TXMULTA: TBCDField
      FieldName = 'CTRCN2TXMULTA'
      Precision = 15
      Size = 3
    end
    object SQLContasReceberCCTRCN2TOTDESCREC: TBCDField
      FieldName = 'CTRCN2TOTDESCREC'
      Precision = 15
      Size = 3
    end
