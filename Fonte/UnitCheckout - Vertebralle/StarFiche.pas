...
uses
  ...
  procedure ImprimeTextoDiverso(Impressora,CaminhoArquivo : String);
...
begin
  if FileExists(CaminhoArquivo) then
    begin
      FormTelaFechamentoVenda.TextStarFiche.FileName := CaminhoArquivo;
      FormTelaFechamentoVenda.ReportStarFiche.PrinterSetup.PrinterName := Impressora;
      FormTelaFechamentoVenda.ReportStarFiche.Print;
      FormTelaFechamentoVenda.TextStarFiche.FileName := '';
      FormTelaFechamentoVenda.TextStarFiche.Close;
    end;
end;
