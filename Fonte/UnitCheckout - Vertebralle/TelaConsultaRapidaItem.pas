    ...
    VK_RETURN :
        begin
          ...
          if (EditPrateleira.Text <> '') then
            if (Filtro = '') then
              begin
                Filtro := 'PRODA15PRATEL like "%' + Copy(EditPrateleira.Text, 2, Length(EditPrateleira.Text)) + '%"';
              end
            else
              begin
                Filtro := Filtro + ' and PRODA15PRATEL like "%' + Copy(EditPrateleira.Text, 2, Length(EditPrateleira.Text)) + '%"';
              end;
