...
begin
        ...
        if ExibirPopUp.Checked then
          DM.SQLPopUPEXIBIRPOP.AsString := 'S'
        else
          DM.SQLPopUPEXIBIRPOP.AsString := 'N';
...
begin
   ...
   if DM.SQLPopUPEXIBIRPOP.AsString = 'S' then
     ExibirPopUp.checked := true
   else
     ExibirPopUp.checked := false;
